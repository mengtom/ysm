...
{
    protected $name = 'crm_platform_token';
    ...
    public static function onBeforeInsert(PlatformToken $token)
    {
     ...
     * @return UserToken
     */
    public static function createToken(Platform $platform, $type): self
    {
        $tokenInfo = $platform->getToken($type);
        return self::create([
