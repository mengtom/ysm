...
use yesai\traits\JwtAuthModelTrait;
...
class CrmUsers extends BaseModel
{
    ...
    protected $insert = ['createtime', 'add_ip', 'last_login', 'last_ip'];

    protected $hidden = [
        'add_ip', 'createtime', 'account', 'clean_time', 'last_ip', 'last_login', 'password', 'status', 'mark', 'type','is_del','platform_leader','institu_leader','doctor_leader'
    ];
