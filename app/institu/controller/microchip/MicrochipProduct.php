<?php
namespace app\institu\controller\microchip;
use app\institu\controller\AuthController;
use yesai\services\FormBuilder as Form;
use app\institu\model\microchip\MicrochipProductIngredient as ingreModel;
use think\facade\Db;
...
use app\institu\model\microchip\MicrochipProductIngredient;
use app\institu\model\microchip\MicrochipProduct as ProductModel;
use app\institu\model\crm\CrmPlatformMicrochip as PlatformMicrochipModel;
use think\facade\Route as Url;
use app\institu\model\system\SystemAttachment;
use app\validate\MicrochipProduct as ProductValidate;
use app\institu\model\microchip\MicrochipIngredient as IngredientModel;
use yesai\services\UploadService as Upload;
use think\exception\ValidateException;
/**
 * 产品管理
 * Class MicrochipProduct
 * @package app\institu\controller\microchip
 */
class MicrochipProduct extends AuthController
{
    ...
    public function index()
    {
        ...
        $cate2=CategoryModel::getCateList(2,1);//getChildList
    ...
    public function product_ist(){
        $where=Util::getMore([
            ...
            ['order',''],
            ['is_show',''],
            ['platform',$this->instituInfo['platform_leader']],
        ],$this->request);
    ...
    public function set_price(){
        ...
        $res = PlatformMicrochipModel::where(["platform_id"=>$this->instituPId,'micro_id'=>$data['id']])->save(['sell_price'=>$data['value']]);
