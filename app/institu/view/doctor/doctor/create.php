			...
			<form class="layui-form" action="{:Url('save')}" method="post">
				<div class="wp-edit-body pl-30 pr-30  h-100 pt-20">
					...
					<div class="items w-100">
						...
						<div class="item mt-20 w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100 mt-8">
									<input style="width: 400px;" type="text" name="account" lay-verify="required" placeholder="由8~16位英文/数字/符号组成" class="ivu-input  w-400px">
								</div>
							</div>
							<div class="ml-50">
						...
						<div class="item mt-20 w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100 mt-8">
									<input type="text" name="refer_mobile"  lay-verify="required" placeholder="由数字/符号组成" class="ivu-input w-400px">
								</div>
							</div>
							<div class="ml-50">
					...
					<div class="item w-100 mt-20 d-flex align-items-center justify-content-start " style="margin-bottom: 30px;">
						<button class="ivu-btn-primary ivu-btn mr-20" lay-submit type="submit">添加医生</button>
