			...
			<div class="w-100 table ">
				...
				<table class="ivu-table  ivu-table-default" style="overflow: initial" id="list">
					...
					<tr class="ivu-table-header cursor">
						...
						<th class="bg-f6 w-250px">机构名称</th>
					...
					<tr v-for="i in 10" class="cursor text-57">
						...
						<td class="ckitem ellipsis-1">上海XXXX科技有限公司 </i></td>
						<td class="ckitem">Mike </i></td>
						...
						<td class="ckitem">80</td>
						<td class="ckitem">30</td>
...
<script type="text/javascript">
    ...
    layList.tableInfo('list',"{:Url('institu_list')}",function (){
        ...
        join=[
            ...
            {field: 'p_name', title: '机构名称',templet:'#p_name',align:'left',event:'p_name',width:'15%'},
            ...
            {field: 'plat_name', title: '所属平台',templet:'#plat_name',align:'left',width:'10%'},
