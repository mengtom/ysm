{include file="public/header"}
	<title>患者管理</title>
	<div class="h-100 w-100 mi-patient" id="app">
		<!--头部-->
		{include file="public/header_navigate"}
		<!--头部-->
		<div class="w-1200 mt-80 mb-10 tip  text-666 size-14">
			<a class="text-57">首页 /</a><span class="text-c01f5e">患者管理 </span>
		</div>
		<!--搜索区-->
					...
					<div class="h-100 pl-20 d-flex align-items-center justify-content-start flex-column mt-20 mb-20">
						<div class="w-100 d-flex align-items-center justify-content-start">
							<div class="h-100 d-flex align-items-center justify-content-start">
								<span class="" style="width: 70px;">患者信息:</span>
								<input class="ivu-input ml-8 w-300px" style="width: 292px;" placeholder="请输入" type="text" name="keyword">
							</div>
							<div class="h-100 ml-20 d-flex align-items-center justify-content-start">
		...
		<div class="w-1200 label-list mt-20 mb-30 bg-fff">
			...
			<div class="w-100 table ">
				...
				<script type="text/html" id="act">
					<a href="" class="text-c01f5e">查看详情</a>
				</script>
			</div>
			<!--page 分页-->
...
<script type="text/javascript">
    ...
    layList.tableInfo('list',"{:Url('get_patient_list')}",function (){
        var join=new Array();
        join=[
            {field: 'user_id', title: '编码',templet:'#user_id',align:'center',event:'user_id',width:'15%'},
            {field: 'nickanme', title: '患者姓名',templet:'#p_name',align:'left',event:'p_name',width:'15%'},
            {field: 'account', title: '联系电话',templet:'#account',align:'left',event:'account',width:'15%'},
            ...
            {field: 'total_end_time', title: '成交金额',templet:'#total_end_time',align:'left',event:'total_end_time',width:'10%'},
            {field:'act',title:'操作',align:'left'}
        ];
        return join;
    ...
    layList.search('export',function(where){
        where.excel = 1;
        location.href=layList.U({m:'institu',c:'crm.crm_patient',a:'get_patient_list',q:where});
    })
