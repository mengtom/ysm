{include file="public/header"}
	...
	<div id="app" class="mi-order-details">
		<!--头部-->
		{include file="public/header_navigate"}
		<!--头部-->
		<div class="w-1200 tip mt-80  text-666 size-14">
			<span>首页 /</span> <a class="text-57" href="index.html">订单管理 </a> <span class="text-c01f5e">/ 订单详情 </span>
		</div>
		...
		<!--列表-->
		<div class="w-1200 pl-30 pr-30  wp-edit pb-10 mb-30" style="border-radius: 1px;  background-color: #ffffff;">
