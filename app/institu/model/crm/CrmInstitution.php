...
// use app\institu\model\crm\CrmCategory as CategoryModel;
use app\institu\model\order\CrmOrder;
...
class CrmInstitution extends BaseModel
{
    ...
    public static function addInstitution($data){
        ...
        $data['plat_type']= $data['plat_type'] ?  $data['plat_type'] : 'platform';
        $data['category']= 3;
        $res = self::field('name,user_id,referrer,refer_mobile,refer_email,ecp,ecm,ece,now_money,currency,createtime,add_ip,plat_type,ca,business_license,place,group,platform_leader,category,institu_discount,institu_commission')->insert($data);
