...
use app\institu\model\ump\MicrochipBargain;
use app\institu\model\ump\MicrochipCombination;
use app\institu\model\ump\MicrochipSeckill;
...
use app\institu\model\order\MicrochipOrder;
use app\institu\model\system\SystemConfig;

/**
 * 产品管理 model
 * Class MicrochipProduct
 * @package app\institu\model\microchip
 */
