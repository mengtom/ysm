<!--头部-->
        <div class="p-topmenu fixed w-100">
            <div class="topmenu_conten h-100 d-flex align-items-center justify-content-between">
                <div class="top_left h-100 d-flex align-items-center justify-content-between w-75 ">
                ...
                <div class="top_right w-25 h-100 d-flex align-items-center justify-content-end cursor">
                    <div class="ellipsis-1 w-50 text-right">
                        <a class="text-27" href="">{$_doctor['name']}{$role_name.role_name ? $role_name.role_name : '医生'}</a>
                        <a class="text-c01f5e ml-10" href="{:Url('login/logout')}">注销</a>
                    </div>
                    <div class="headimg">
