...
<title>{if condition="$product['id']"}编辑{else /}添加{/if}成分</title>
	<div id="app" class="wp-editingredient">
		...
		<div class="w-1200  wp-edit pb-10" style="border-radius: 1px;  background-color: #ffffff;">
			<form class="layui-form" action="{if condition="$product['id']"}{:Url('update',array('id'=>$product['id']))}{else /}{:Url('save')}{/if}" method="post">
				<div class="wp-edit-body  h-100 pt-20">
					<div class="items w-100">
						<div class="item w-100 ">
							<div class=" size-14 item-text">成分编码<span class="text-ff4d4f">*</span></div>
							<div class=" w-100">
								<input style="width: 400px;" name="code" type="text" placeholder="请输入" class="ivu-input ml0" value="{$product.code}">
							</div>
						</div>
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start  ">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" name="zn_name" placeholder="由英文/数字/符号组成" class="ivu-input ml0" value="{$product.zn_name}">
								</div>
							</div>
						...
						<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
							<div style="width: 230px;">
								...
								<div class="w-100 mt-8">
									<input type="text" id="material" name="price" class="ivu-input" placeholder="请输入" value="{$product.price}">
								</div>
							</div>
