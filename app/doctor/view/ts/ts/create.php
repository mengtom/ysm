{include file="public/header"}
	...
	<div id="app" class="ts-edit pr-20 pl-20 mw-1160">
		...
		<div class="w-100  mt-10 pb-10 mb-30" style="border-radius: 1px;">
			<form class="d-flex w-100 layui-form  align-items-start justify-content-between" id="formput" action="{:Url('save')}" method="post">
	...
	var app = new Vue({
		...
		data   : {
			...
			hxcflistdata: [
				...
				"pid"     : '0',
				"name"    : '{$m.zn_name}',
				"scope"   : '{$m.dose_min}-{$m.dose_max}',
				"maxnum"  : '{$m["dose_max"]/$m["dose"]|round}',
				'unit'    : '{$m.unit}',
				"val"     : '1',
				'dosage'  : '{$m.dose}',
				"dosage1" : '{$m.dose}',
				"rmbprice": '{$m.plat_price}',
				"is_status": '{$m.is_show}',
				},
				{/volist}
			],
