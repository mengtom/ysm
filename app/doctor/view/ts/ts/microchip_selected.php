						...
						<div class="mt-10 items1" style="width: 754px;margin: auto">
							...
							<div class="">
								...
								<div v-for="(i,k) in items1" class="w-100  d-flex align-items-center justify-content-start" style="height: 38px;border-bottom: 1px solid #f9f9f9;">
									...
									<i :data-name="i.zn_name" :data-pid="i.id" :data-id="i.micro_id" :data-kind="i.id" :data-scope="i.dose" :data-maxnum="i.dose_max" :data-unit="i.unit" data-val="1" :data-dosage="i.dose" :data-dosage1="i.dose" :data-rmbprice="i.sell_price" :data-type="1" :data-status="
	...
	var app = new Vue({
		...
		methods: {
			...
			search() {
				var data = this.where;
				var that = this;
				axios.post("{:Url('microchip.microchipProduct/product_list')}", data).then(function (e) {
			...
			search1() {
				...
				var that = this;
				axios.post("{:Url('ts_selected')}", data).then(function (e) {
