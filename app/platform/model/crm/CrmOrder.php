...
use app\platform\model\crm\CrmPlatformMicrochip as MicrochipModel;
use app\platform\model\crm\CrmOrderMicrochip as OrderMicrochip;
...
HTML;
    ...
    public static function getOrderWhere($where, $model, $aler = '', $join = '')
    {
        ...
        if(isset($where['doctor_id']) && $where['doctor_id'] !=''){
            $model=$model->where($aler.'institu_leader',$where['doctor_id']);
        }
