...
class CrmDoctor extends BaseModel
{
    ...
    public static function addDoctor($data){
        ...
        $data['category']= 2;
        $res = self::field('name,user_id,referrer,refer_mobile,refer_email,now_money,currency,createtime,add_ip,plat_type,group,platform_leader,category')->insert($data);
        return $res;
    }
    /**
     * 获取单个平台信息
