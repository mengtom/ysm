<?php
namespace app\platform\controller\microchip;
use app\platform\controller\AuthController;
use yesai\services\FormBuilder as Form;
use app\platform\model\microchip\MicrochipProductIngredient as ingreModel;
use think\facade\Db;
...
use app\platform\model\microchip\MicrochipProductIngredient;
use app\platform\model\microchip\MicrochipProduct as ProductModel;
use app\platform\model\crm\CrmPlatformMicrochip as PlatformMicrochipModel;
use think\facade\Route as Url;
use app\platform\model\system\SystemAttachment;
use app\validate\MicrochipProduct as ProductValidate;
use app\platform\model\microchip\MicrochipIngredient as IngredientModel;
use yesai\services\UploadService as Upload;
use think\exception\ValidateException;
/**
 * 产品管理
 * Class MicrochipProduct
 * @package app\platform\controller\microchip
 */
