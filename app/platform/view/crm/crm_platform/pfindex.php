...
<script type="text/javascript">
    ...
    layList.tableList('list',"{:Url('platform_ingredient',array('id'=>$platform.id))}",function (){
        ...
        join=[
            ...
            {field: 'zn_name', title: '平台TS配方',templet:'#zn_name',align:'center',event:'zn_name',width:'25%'},
            {field: 'en_name', title: '英文名称',templet:'#en_name',align:'center',event:'en_name',width:'21.5%'}, //edit:'en_name',
