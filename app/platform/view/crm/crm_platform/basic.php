					...
					<div class="items w-100">
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" lay-verify="required" value="{$platform.account}">
								</div>
							</div>
						...
						<div class="item w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" lay-verify="required" placeholder="由中文/英文/数字/符号组成" class="ivu-input ml0" name="referrer" value="{$platform.referrer}">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class="w-100 d-flex align-items-center justify-content-start">
									<div>
										...
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input style="width: 190px;" type="text" lay-verify="required" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="refer_mobile" value="{$platform.refer_mobile}">
										</div>
									</div>
									<div>
