				...
				<div class="wp-edit-body  h-100 pt-20">
					...
					<div class="items w-100">
						<div class="item w-100">
							...
							<div class=" w-100">
								<input style="width: 400px;" type="text" name="name" lay-verify="required" placeholder="由中文/英文/数字/符号组成" class="ivu-input ml0">
							</div>
						</div>
					...
					<div class="item w-100 mt-20 d-flex align-items-center justify-content-start mb-30">
						...
						<button class="ivu-btn-primary ivu-btn mr-20" lay-submit type="submit">添加机构</button>
