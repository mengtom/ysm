							...
							{elseif condition="$tab_id eq 4" /}
								...
								<div class="item pl-30  w-100 d-flex align-items-center justify-content-start mt-10">
									<div>
										<div class=" size-14 item-text">{$list.3.info}</div>
										<div class="w-100 d-flex align-items-center justify-content-start mt-8">
											<input  type="{$list.3.type}" placeholder="请输入" value="0" {eq name="$list.3.value|json_decode" value="0"} checked="checked"{/eq} class="ivu-input w-400px ml0" name="{$list.3.menu_name}">
										</div>
									</div>
								</div>
								<div class="item pl-30  w-100 d-flex align-items-center justify-content-start mt-20">
								...
								<div class="item pl-30  w-100 d-flex align-items-center justify-content-start mt-20">
									<div>
										<div class=" size-14 item-text">{$list.5.info}</div>
										<div class="w-100 d-flex align-items-center justify-content-start mt-8">
											<input  type="{$list.5.type}" placeholder="{$list.5.desc}" value="{$list.5.value|json_decode}" class="ivu-input w-400px ml0" readonly>
										</div>
									</div>
								</div>
								<div class="item pl-30  w-100 d-flex align-items-center justify-content-start mt-20">
									<div>
										<div class=" size-14 item-text">{$list.6.info}</div>
										<div class="w-100 d-flex align-items-center justify-content-start mt-8">
										<input  type="{$list.6.type}" placeholder="请输入" value="1" class="ivu-input w-400px ml0" name="{$list.6.menu_name}" {eq name="$list.6.value|json_decode" value="1"} checked="checked"{/eq}>开启
											<input  type="{$list.6.type}" placeholder="请输入" value="0" class="ivu-input w-400px ml0" name="{$list.6.menu_name}" {eq name="$list.6.value|json_decode" value="0"} checked="checked"{/eq}>关闭
