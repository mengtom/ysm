...
class CrmOrder extends Validate
{
    ...
    {
        return $this->only(['real_name','user_phone','order_name','symptom','taking_quency','taking_time','taking_cycle','taking_suggest','taking_remark']);
    }
    public function scenePurchase(){
    	 return $this->only(['real_name','user_phone','user_phone2','order_name','taking_quency','taking_time','taking_cycle','taking_suggest','taking_remark','idcard']);
    }
    /*
	 正则验证身份证号码  by雨沫
	 */
