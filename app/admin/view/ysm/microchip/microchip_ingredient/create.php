...
<div id="app" class="wp-editingredient" >
    ...
    <div class="w-1200  mt-80 tip mt-10  text-666 size-14" >
        <span >首页 /</span > <a class="text-57" href="javascript:;" >微片 /</a > <a class="text-57" href="{:Url('index')}" >成分管理 </a >
        <span class="text-c01f5e" >/ {if condition="$product['id']"}编辑{else /}添加{/if}成分 </span >
    ...
    <div class="w-1200  wp-edit pb-10" style="border-radius: 1px;  background-color: #ffffff;" >
        <form  class="layui-form" action="{if condition=" $product[
        'id']"}{:Url('update',array('id'=>$product['id']))}{else /}{:Url('save')}{/if}" method="post">
        <div class="wp-edit-body  h-100 pt-20" >
            <div class="items w-100" >
                <div class="item w-100 " >
                    <div class=" size-14 item-text" >成分编码<span class="text-ff4d4f" >*</span ></div >
                    <div class=" w-100" >
                        <input style="width: 400px;" name="code" type="text" placeholder="请输入" lay-verify="required" class="ivu-input ml0 classvaild" value="{$product.code}" >
                    </div >
                </div >
                ...
                <div class="item  w-100 d-flex align-items-center justify-content-start  " >
                    <div >
                        ...
                        <div class="w-100" >
                            <input style="width: 400px;" type="text" name="zn_name" lay-verify="required" placeholder="由英文/数字/符号组成" class="ivu-input ml0 classvaild" value="{$product.zn_name}" >
                        </div >
                    </div >
                        ...
                        <div class="w-100" >
                            <div class="ivu-select  ivu-select-single ivu-select-default relative w-400px" >
                                <select name="cate_id"  >
                                    ...
                                    <option value="{$vo.cate_id}" {eq name="vo.cate_id" value="product.cate_id" }selected="selected" {
                                    /eq}>{$vo.cate_name}</option>
                                    {/volist}
                                </select >
                            </div >
                        </div >
                ...
                <div class="item w-100 mt-20 d-flex align-items-center justify-content-start  " >
                    <div style="width: 230px;" >
                        ...
                        <div class="w-100 mt-8" >
                            <input type="text" id="material" name="price" lay-verify="required" class="ivu-input classvaild" placeholder="请输入" value="{$product.price}" >
                        </div >
                    </div >
                ...
                <div class="item w-100 mt-20 d-flex align-items-center justify-content-start " style="margin-bottom: 30px;" >
                    <button class="ivu-btn-primary ivu-btn mr-20" lay-submit type="submit" >确定</button >
