...
<div id="app" class="wp-edit">
	...
	<div class="w-1200  wp-edit pb-10 mb-30" style="border-radius: 1px;  background-color: #ffffff;">
		<form class="layui-form"  action="{:url('update',array('id'=>$id))}" method="post" multiple>
			<div class="wp-edit-body  h-100 pt-20">
				...
				<div class="items w-100">
						...
						<div class=" w-100">
							<div class="ivu-select  ivu-select-single ivu-select-default relative w-200px">
								<select name="cate_id" class="w-200px" lay-verify="required">
									...
									<option value="{$vo.id}" {eq name="$vo.id" value="$info.cate_id"} selected="selected" {/eq}>{$vo.html}{$vo.title}</option>
									{/volist}
								</select>
							</div>
						</div>
					...
					<div class="item w-100 ">
						...
						<div class=" w-100">
							<input style="width: 400px;" type="text" lay-verify="required" placeholder="由英文/数字/符号组成" class="ivu-input ml0 classvaild" name="code" value="{$info.code}">
						</div>
					</div>
					...
					<div class="item  w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<input style="width: 400px;" type="text" lay-verify="required" placeholder="由英文/数字/符号组成" class="ivu-input ml0 classvaild" name="zn_name" value="{$info.zn_name}">
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Name</div>
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="en_name" value="{$info.en_name}">
							</div>
						</div>
					</div>
					...
					<div class="item w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="scientific_zn_name" value="{$info.scientific_zn_name}">
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Scientific name</div>
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="scientific_en_name" value="{$info.scientific_en_name}">
							</div>
						</div>
					</div>
					...
					<div class="item w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="microchip_info_zn" >{$info.microchip_info_zn}</textarea>
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Product description</div>
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="microchip_info_en">{$info.microchip_info_en}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="item w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="effects_zn">{$info.effects_zn}</textarea>
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Side effects</div>
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="effects_en">{$info.effects_en}</textarea>
							</div>
						</div>
					</div>
					...
					<div class = "item w-100 d-flex align-items-center justify-content-start  ">
						<div >
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "w-190px">
									<input type = "text" class = "ivu-input w-100 weight" placeholder = "请输入数字" name="weight" value="{$info.weight}">
								</div>
						...
						<div class = "">
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-150px">
									...
									<!--		<span>￥</span>-->
									<!--		<span class = "cogtotalrmbprice">{$info.cost_rmb}</span>-->
									<!--	</span>-->
									<!--<span v-show="cogeditshow">-->
									<!--		 <div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-150px">-->
		                            <!--            <input autocomplete = "off"  spellcheck = "false" type = "text" placeholder = "RMB" class = "ivu-input ivu-input-default ivu-input-with-prefix cogtotalrmbpriceinput" name="cost_rmb" value="{$info.cost_rmb}">-->
								...
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text text-27 w-150px">
									<!--	<span v-show="!cogeditshow">-->
									<!--		<span>$</span>-->
									<!--		<span class = "cogtotalusdprice">{$info.cost_usd}</span>-->
									<!--	</span>-->
									<!--<span v-show="cogeditshow">-->
									<!--		 <div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-150px">-->
		                            <!--            <input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix cogtotalusdpriceinput" name="cost_usd" value="{$info.cost_usd}">-->
...
<<<<<<< HEAD
								<input id="coginput" name="coginput" class="hide" type="radio" lay-ignore value="{$info.pricinginput}">
								<label  @click="cogedit()" for="coginput"   class = "ml-10 text-c01f5e cursor">编辑</label>
=======
								<input id="coginput" name="coginput" class="hide" {eq name="$info.coginput" value="1"}checked="checked"{/eq} type="radio" lay-ignore value="1" >
								<!--<label  @click="cogedit()" for="coginput"   class = "ml-10 text-c01f5e cursor">编辑</label>-->
>>>>>>> ef1ea3db0246a84d42dd3b63334d23892d612113
							</div>
						</div>
					</div>
				</div>
						...
						<div >
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-150px">
									...
									<!--		<span>￥</span>-->
									<!--		<span class = "pricingpricermb">{$info.pricing_rmb}</span>-->
									<!--	</span>-->
									<!--<span v-show="pricingshow">											-->
									<!--		<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-150px">-->
		                            <!--            <input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix pricingpricermbinput" name="pricing_rmb" value="{$info.pricing_rmb}">-->
		                            <!--            <span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-yen" style = "color: #272727;font-size: 14px;"></i></span>-->
									<!--		 </div>-->
										<!--</span>-->
									<span >
								...
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text text-27 w-150px">
									<!--	<span v-show="!pricingshow">-->
									<!--		<span>$</span>-->
									<!--		<span class="pricingpriceusd" >{$info.pricing_usd}</span >-->
									<!--	</span>-->
									<!--<span v-show="pricingshow" >											-->
									<!--		<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-150px">-->
		                            <!--            <input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix pricingpriceusdinput" name="pricing_usd" value="{$info.pricing_usd}">-->
		                            <!--            <span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-usd" style = "color: #272727;font-size: 14px;"></i></span>-->
									<!--		</div>-->
									<!--	</span>-->
									<span  >
...
<<<<<<< HEAD
								<input id="pricinginput" class="hide" type="radio" lay-ignore value="{$info.pricinginput}" name='pricinginput'>
								<label for="pricinginput" @click="pricingedit()"   class = "ml-10 text-c01f5e cursor">编辑</label>
=======
								<input id="pricinginput" class="hide" {eq name="$info.pricinginput" value="1"}checked="checked"{/eq} class="" type="radio" lay-ignore value="1"   >
								<!--<label for="pricinginput" @click="pricingedit()"   class = "ml-10 text-c01f5e cursor">编辑</label>-->
>>>>>>> ef1ea3db0246a84d42dd3b63334d23892d612113
						...
						<div>
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
									<input autocomplete = "off" spellcheck = "false" lay-verify="required" type = "text" placeholder = "RMB" class = "ivu-input classvaild ivu-input-default ivu-input-with-prefix" name="price" value="{$info.price}">
									<span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-yen" style = "color: #272727;font-size: 14px;"></i></span>
								</div>
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-190px">
									<input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix" name="usd" value="{$info.usd}">
									<span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-usd" style = "color: #272727;font-size: 14px;"></i></span>
								</div>
							</div>
				...
				<div class="items w-100">
					...
					<div class="w-100 d-flex align-items-center justify-content-start flex-column  hxcflist">
						...
						<div class="w-100 mt-10 hxcflistitems">
							{volist name="info.ingredient.0" id="vo"}
							<div class="hxcfitem w-100 d-flex align-items-center justify-content-around"  style="height: 40px;">
								<!--编辑新增-->
								<span class="hide cfsingledata" data-name='{$vo.name}' data-code="{$vo['code']}" data-dose="{$vo['dose']}" data-unit="{$vo['unit']}" data-rmbprice='{$vo['price_rmb']}' data-usdprice='{$vo['price_usd']}'></span>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[{$vo.ingredient_id}][name]" type="hidden" value="{$vo['name']}">
									{$vo.name}
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[{$vo.ingredient_id}][code]" type="hidden" value="{$vo['code']}">
									{$vo.code}
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[{$vo.ingredient_id}][dose]" type="hidden" value="{$vo['dose']}" oninput = " value=value.replace(/[^\d.]/g,'')" >
									{$vo.dose}
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[{$vo.ingredient_id}][unit]" type="hidden" value="{$vo['unit']}">
									{$vo.unit}
								</div>
						...
						<div class="w-100 mt-10 d-flex align-items-center justify-content-around hxcfitem" style="height: 40px;">
							...
							<div class="ivu-select  ivu-select-single ivu-select-default relative ml-10 mr-10 w-200px">
								<select class="w-200px cfcode" lay-filter="test4"  lay-search="">
									...
									<!--data-rmbprice="1" 代表该批次的人民币价格 data-usdprice="{$h.price_rmb}" 代表该批次的美元价格 -->
									{volist name="huo_micro" id="h"}
				...
				<div class="items w-100">
					...
					<div class="w-100 d-flex align-items-center justify-content-start flex-column  fllist">
						...
						<div class="w-100 mt-10 fllistitems">
							{volist name="info.ingredient.1" id="vo"}
							<div class="hxcfitem w-100 d-flex align-items-center justify-content-around"  style="height: 40px;">
								<!--编辑新增-->
								<span class="hide flsingledata" data-name='{$vo.name}' data-code="{$vo['code']}" data-dose="{$vo['dose']}" data-unit="{$vo['unit']}" data-rmbprice='{$vo['price_rmb']}' data-usdprice='{$vo['price_usd']}'></span>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[{$vo.ingredient_id}][name]" type="hidden" value="{$vo['name']}">
									{$vo.name}
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[{$vo.ingredient_id}][code]" type="hidden" value="{$vo['code']}">
									{$vo.code}
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[{$vo.ingredient_id}][dose]" type="hidden" value="{$vo['dose']}" >
									{$vo.dose}
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[{$vo.ingredient_id}][unit]" type="hidden" value="{$vo['unit']}">
									{$vo.unit}
								</div>
								<div class="d-flex align-items-center justify-content-start ml-20" style="width: 150px;">
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
						...
						<div class="w-100 mt-8">
							<div class="ivu-select  ivu-select-single ivu-select-default relative w-400px">
								<select name="unit" lay-verify="required">
									<option value="">请选择</option>
									<option value="iu" {eq name="$info.unit" value="iu"}selected="selected"{/eq}>iu</option>
									<option value="mg" {eq name="$info.unit" value="mg"}selected="selected"{/eq}>mg</option>
									<option value="ml" {eq name="$info.unit" value="ml"}selected="selected"{/eq}>ml</option>
									<option value="mcg"{eq name="$info.unit" value="mcg"}selected="selected"{/eq}>mcg</option>
								</select>
							</div>
						</div>
					</div>
					<div style="margin-left: 50px;">
						...
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" lay-verify="number" placeholder="请输入数字" class="ivu-input ml0" name="day_max" value="{$info.day_max}">
						</div>
					</div>
				</div>
				...
				<div class="item mt-20 w-100 d-flex align-items-center justify-content-start  ">
					<div>
						...
						<div class="w-100 mt-8 d-flex align-items-center justify-content-center">
							<input type="text" placeholder="请输入最小值" lay-verify="required" class="ivu-input classvaild mr-20 w-190px" name="dose_min" value="{$info.dose_min}">
							<input type="text" placeholder="请输入最大值" lay-verify="required" class="ivu-input classvaild w-190px" name="dose_max" value="{$info.dose_max}">
						</div>
					</div>
					<div style="margin-left: 50px;">
						<div class=" size-14 item-text">剂量显示/单次增量<span class="text-ff4d4f">*</span></div>
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" placeholder="请输入数字" lay-verify="required" class="ivu-input ml0" name="dose" value="{$info.dose}">
						</div>
					</div>
				</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
					<div>
						...
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" lay-verify="required" class="ivu-input classvaild" placeholder="由中文/英文/数字/符号组成" name="facts_name" value="{$info.facts_name}">
						</div>
					</div>
					<div style="margin-left: 50px;">
						<div class=" size-14 item-text">%Daily Value<span class="text-ff4d4f">*</span></div>
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" lay-verify="required" class="ivu-input classvaild" placeholder="请输入数字"  name="facts_daily" value="{$info.facts_daily}">
						</div>
					</div>
				</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
					<div style="width: 230px;">
						...
						<div class="w-100 mt-8">
							<input type="text" class="ivu-input classvaild" lay-verify="required" placeholder="请输入数字"  name="amount" value="{$info.amount}">
						</div>
					</div>
						...
						<div class="w-100 mt-8">
							<div class="ivu-select  ivu-select-single ivu-select-default relative " style="width: 150px;">
								<select name="facts_unit" class="w-200px" lay-verify="required">
									...
									<option value="iu" {eq name="$info.facts_unit" value="iu"}selected="selected"{/eq}>iu</option>
									<option value="mg" {eq name="$info.facts_unit" value="mg"}selected="selected"{/eq}>mg</option>
									<option value="ml" {eq name="$info.facts_unit" value="ml"}selected="selected"{/eq}>ml</option>
									<option value="mcg"{eq name="$info.facts_unit" value="mcg"}selected="selected"{/eq}>mcg</option>
								</select>
							</div>
						</div>
					</div>
					<div style="margin-left: 50px;">
						...
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="number" class="ivu-input" placeholder="请输入数字"  name="facts_sort" value="{$info.facts_sort}">
						</div>
					</div>
				</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
					<textarea rows="7" style="width: 850px;" placeholder="请输入" class="ivu-input" name="references">{$info.references}</textarea>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start ">
					<div class="cursor d-flex align-items-center justify-content-center flex-column filesft">
						<input id="image_input" type="text" class="hide" name="image" maxlength="1" value="{$info.image}">
						<!--上传前-->
						...
						<span class="w-100 h-100 imgupdata">
								<span class="relative w-100 h-100 d-flex align-items-center justify-content-center">
									<img class="absolute w-100 image_img" {if condition="$info.image"} src="{$info.image}" {else/}src="{__ADMIN_FRAME}/images/zimg-logo.png" {/if}alt="">
					...
					<div class="mt-8 w-100 basic-updata-items" style="">
						...
						<div class="basic-updata-item">
							<div class="relative w-100">
								...
								<input type="hidden" name="files[]" value="{$f.path}">
							</div>
						</div>
						{/volist}
					</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start " style="margin-bottom: 30px;">
					<button class="ivu-btn-primary ivu-btn mr-20" lay-submit type="submit">编辑微片</button>
...
<script>
	...
	$('.imgdelete').click(function () {
		...
		$(".image_img").attr('src','{__ADMIN_FRAME}/images/zimg-logo.png');
	});
