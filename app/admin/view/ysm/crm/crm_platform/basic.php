				...
				<div class="wp-edit-body  h-100 pt-20">
					...
					<div class="items w-100">
						<div class="item w-100 ">
							...
							<div class=" w-100">
								<input style="width: 400px;" type="text" placeholder="由中文/英文/数字/符号组成" required  lay-verify="required" class="ivu-input ml0" name="p_name" value="{$platform.p_name}">
							</div>
						</div>
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" required  lay-verify="required" class="ivu-input ml0" value="{$platform.account}">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class=" size-14 item-text">重置密码<span class="text-ff4d4f">*</span></div>
								<div class="w-100">
									<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" required  lay-verify="required" class="ivu-input ml0" name="repassword">
						...
						<div class="item w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" placeholder="由中文/英文/数字/符号组成" required  lay-verify="required" class="ivu-input ml0" name="referrer" value="{$platform.referrer}">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class="w-100 d-flex align-items-center justify-content-start">
									<div>
										...
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input style="width: 190px;" required  lay-verify="required" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="refer_mobile" value="{$platform.refer_mobile}">
										</div>
									</div>
									<div>
						...
						<div class="item w-100 d-flex align-items-start justify-content-start">
							<div class="w-400px">
								<div class="size-14 item-text d-flex align-items-center">
									...
									<input type="number" max="99" placeholder="请输入" class="ivu-input w-100px" name="default_discount" value="{$platform.default_discount}">
								</div>
							...
							<div  style="margin-left: 50px;">
								...
								<div class="w-400px wind">
									...
									<div  class="w-100 d-flex align-items-center justify-content-center h-38">
										<div class="w-100px ellipsis-1 text-center"><input type="text" class="ivu-input text-center" placeholder="请输入" name="first_weight" value="{$platform.first_weight}"></div>
										<div class="w-100px ellipsis-1 text-center"><input type="text" class="ivu-input text-center" placeholder="请输入" name="first_payment" value="{$platform.first_payment}"></div>
										<div class="w-100px ellipsis-1 text-center"><input type="text" class="ivu-input text-center" placeholder="请输入" name="re_weight" value="{$platform.re_weight}"></div>
										<div class="w-100px ellipsis-1 text-center"><input type="text" class="ivu-input text-center" placeholder="请输入" name="re_payment" value="{$platform.re_payment}"></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="d-flex align-items-start justify-content-start useroder">
								<div class="w-50 h-100">
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										...
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.institu_c}</div>
									</div>
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										<div class="w-150px h-100 bg-f6 pl-20 d-flex align-items-center fw">下属独立医生数量</div>
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.doctor}</div>
									</div>
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										<div class="w-150px h-100 bg-f6 pl-20 d-flex align-items-center fw">下属医生总数量</div>
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.doctor_c}</div>
									</div>
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										<div class="w-150px h-100 bg-f6 pl-20 d-flex align-items-center fw">患者数量</div>
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.patient_c}</div>
									</div>
								</div>
								<div class="w-50 h-100">
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										<div class="w-150px h-100 bg-f6 pl-20 d-flex align-items-center fw">开具处方数量</div>
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.order_prescript_c}</div>
									</div>
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										<div class="w-150px h-100 bg-f6 pl-20 d-flex align-items-center fw">目前成单数量</div>
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.order_c}</div>
									</div>
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
										<div class="w-150px h-100 bg-f6 pl-20 d-flex align-items-center fw">成交金额</div>
										<div class="w-150px h-100 d-flex align-items-center justify-content-end pr-20">{$platform.order_price_c}</div>
									</div>
									<div class="w-100 d-flex align-items-center justify-content-start useroder-item">
