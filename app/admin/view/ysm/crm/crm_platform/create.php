{include file="public/header"}
	...
	<div id="app" class="cmr-basic">
		...
		<div class="w-1200 tip mt-80  text-666 size-14">
			<span>首页 /</span> <a class="text-57t" href="{:Url('crm.crm_platform/index')}">平台管理 </a> <span class="text-c01f5e">/ 添加平台 </span>
		</div>
				...
				<div class="wp-edit-body  h-100 pt-20">
					...
					<div class="items w-100">
						<div class="item w-100 ">
							...
							<div class=" w-100">
								<input style="width: 400px;" type="text" name="p_name" lay-verify="required" placeholder="由中文/英文/数字/符号组成" class="ivu-input classvaild ml0">
							</div>
						</div>
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start  ">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" name="account" placeholder="由8~16位英文/数字/符号组成" lay-verify="required" class="ivu-input classvaild ml0">
								</div>
							</div>
						...
						<div class="item w-100 d-flex align-items-center justify-content-start  ">
							<div>
								...
								<div class="w-100">
									<input style="width: 400px;" type="text" name="referrer" placeholder="由中文/英文/数字/符号组成" class="ivu-input classvaild ml0">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class="w-100 d-flex align-items-center justify-content-start">
									<div>
										...
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input style="width: 190px;" type="text" name="refer_mobile" placeholder="由数字/符号组成" class="ivu-input classvaild ml0">
										</div>
									</div>
									<div>
					...
					<div class="item w-100 mt-20 d-flex align-items-center justify-content-start " style="margin-bottom: 30px;">
						...
						<button class="ivu-btn-primary ivu-btn mr-20" lay-submit type="submit">添加平台</button>
