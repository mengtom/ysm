								...
								<div class="w-100 mt-8">
									<div class="ivu-select  ivu-select-single ivu-select-default relative w-190px">
										<select id="frequency" lay-filter="frequency" class="frequency" lay-verify="required" name="taking_quency">
											<option value="">请选择</option>
											<option value="一日一次" {eq name="'一日一次'" value="$info.taking_quency"}selected="selected"{/eq}>一日一次</option>
											<option value="一日二次" {eq name="'一日二次'" value="$info.taking_quency"}selected="selected"{/eq}>一日二次</option>
											<option value="一日三次" {eq name="'一日三次'" value="$info.taking_quency"}selected="selected"{/eq}>一日三次</option>
										</select>
									</div>
								</div>
							</div>
							...
							<div class="w-100 mt-8">
								<div class="ivu-select  ivu-select-single ivu-select-default relative w-400px">
									<select id="period" class="period" lay-filter="period" lay-verify="required" name="taking_cycle">
										<option value="">请选择</option>
										<option value="10天" {eq name="'10天'" value="$info.taking_cycle"}selected="selected"{/eq}>10天</option>
										<option value="20天" {eq name="'20天'" value="$info.taking_cycle"}selected="selected"{/eq}>20天</option>
										<option value="30天" {eq name="'30天'" value="$info.taking_cycle"}selected="selected"{/eq}>30天</option>
										<option value="60天" {eq name="'60天'" value="$info.taking_cycle"}selected="selected"{/eq}>60天</option>
										<option value="90天" {eq name="'90天'" value="$info.taking_cycle"}selected="selected"{/eq}>90天</option>
									</select>
								</div>
							</div>
						</div>
		...
		<div style="display: none;" class="modal-root ts-edit-modal">
			...
			<div class="ant-modal fixed" style="width : 852px ;height: 520px ;">
				...
				<div class="items w-100" style="height: 520px;margin-top: 0;">
					<iframe src="{:Url('microchip_selected',array('type'=>$type))}" class="w-100 h-100" style="border: none"></iframe>
				</div>
			</div>
		</div>
