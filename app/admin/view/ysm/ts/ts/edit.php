{include file="public/header"}
	...
	<div id="app" class="ts-edit">
		...
		<div class="w-1200  wp-edit mt-10 pb-10 mb-30" style="border-radius: 1px;">
			<form class="d-flex layui-form  align-items-start justify-content-between" id="formput" action="{:Url('save',array('id'=>$info['id']))}" method="post">
				...
				<div class="wp-edit-body h-100 pt-20 bg-fff" style="width: 900px;margin: initial">
					...
					<div class="items pl-30 w-100">
						<div class="item w-100 ">
							...
							<div class=" w-100">
								<input type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0 w-400px classvaild" name="code" value="{$info.code}">
							</div>
						</div>
            ...
            <div class="items pb-30 pt-20">
                <div style="width: 90%;margin: auto;">
					...
					<div style="border: 1px solid #000;">
						<div v-for="i in factsdata.facts" class="h-32px w-100 d-flex  item pl-10">
							...
							<div class="w-20 h-100 d-flex align-items-center justify-content-end pr-30">{{i.facts_daily}} %</div>
						</div>
					</div>
		...
		for (var i = 0; i < arr.length; i++) {
			...
			if (!map[ai.kind]) {
				...
				for (var j = 0; j < dest.length; j++) {
					var dj = dest[j];
					if (parseInt(dj.kind) == parseInt(ai.kind)) {
