...
//            ['access',''],
    ...
    public function create($cid = 0)
    {
        ...
        $field[] = Form::select('module','模块名')->options([['label'=>'总后台','value'=>'admin'],['label'=>'平台','value'=>'platform'],['label'=>'医生','value'=>'doctor'],['label'=>'机构','value'=>'institu']]);
    ...
    public function edit($id)
    {
        ...
        $field[] = Form::select('module','模块名',$menu['module'])->options([['label'=>'总后台','value'=>'admin'],['label'=>'平台','value'=>'platform'],['label'=>'医生','value'=>'doctor'],['label'=>'机构','value'=>'institu']]);
