 ...
 */
class CrmInstitution extends AuthController
{
    ...
    {
        $platform=PlatformModel::PlatformList(['category'=>4,'page'=>'','limit'=>'']);
    ...
    public function institu_list()
    {
        ...
        return Json::successlayui(InstituModel::InstituList($where));
    }
