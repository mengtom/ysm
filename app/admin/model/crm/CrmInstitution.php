...
class CrmInstitution extends BaseModel
{
    ...
    public static function InstituList($where,$fieldout=[]){
        ...
        foreach ($data as &$item){
             ...
             $item['total_doctor'] = Db::name("crm_doctor")->where(['category'=>1,'institu_leader'=>$item['id'],'status'=>1])->count();
             $item['total_patient'] = Db::name("crm_users")->where(['type'=>0,'institu_leader'=>$item['id'],'is_del'=>0])->count();
