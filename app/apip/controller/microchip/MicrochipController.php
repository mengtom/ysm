...
namespace app\apip\controller\microchip;

use app\platform\model\system\SystemAttachment;
use app\models\system\SystemStore;
use app\models\crm\CrmPlatformMicrochip as microchipModel;
...
use yesai\services\QrcodeService;
...
class MicrochipController
{
    ...
    public function list(Request $request)
    {
        ...
        return app('json')->success('获取成功',microchipModel::getMicrochipList($data, $request->pid()));
    }
            ...
            switch ($userType) {
                ...
                case 'routine':
                    ...
                    if (!$imageInfo) {
                        ...
                        $imageInfo = \yesai\services\UploadService::instance()->setUploadPath('routine/product')->imageStream($name, $res);
