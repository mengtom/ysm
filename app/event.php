...
return [
    ...
    'listen'    => [
        ...
        'WechatMessageBefore' => [], // MessageSubscribe 微信消息前置操作  yesai\services\WechatService
        'WechatEventUnsubscribeBefore' => [], // MessageSubscribe 用户取消关注公众号前置操作  yesai\services\WechatService
        ...
        'onPlatformLoginAfter' => [], // SystemSubscribe 添加平台最后登录时间和ip 添加管理员访问记录 admin模块 system.SystemAdmin控制器
        'PlatformVisit' => [], // SystemSubscribe 添加平台访问记录 platform模块 AuthController控制器
        'onInstituLoginAfter' => [], // SystemSubscribe 添加平台最后登录时间和ip 添加管理员访问记录 admin模块 system.SystemAdmin控制器
        'InstituVisit' => [], // SystemSubscribe 添加平台访问记录 institu AuthController控制器
        'onDoctorLoginAfter' => [], // SystemSubscribe 添加平台最后登录时间和ip 添加管理员访问记录 admin模块 system.SystemAdmin控制器
        'DoctorVisit' => [], // SystemSubscribe 添加平台访问记录 institu AuthController控制器
    ],

    'subscribe' => [
        yesai\subscribes\SystemSubscribe::class,
        yesai\subscribes\OrderSubscribe::class,
        yesai\subscribes\ProductSubscribe::class,
        yesai\subscribes\UserSubscribe::class,
        yesai\subscribes\MaterialSubscribe::class,
        yesai\subscribes\MessageSubscribe::class,
        yesai\subscribes\TaskSubscribe::class,
        yesai\subscribes\PlatformSubscribe::class,
        yesai\subscribes\InstituSubscribe::class,
        yesai\subscribes\DoctorSubscribe::class,
    ],
];
