...
/**
 * Created by yesai.
 * Copyright (c) 2017~2019 http://www.yesai.com All rights reserved.
 * Author: liaofei <136327134@qq.com>
 * Date: 2019/4/3 16:36
 */

namespace yesai\utils;

use yesai\exceptions\AuthException;
use yesai\traits\LogicTrait;
use think\app\Url;
...
class Template
{
     ...
     */
    protected $providers = [
        'routine' => \yesai\services\ProgramTemplateService::class,
        'subscribe' => \yesai\services\SubscribeTemplateService::class,
        'wechat' => \yesai\services\WechatTemplateService::class,
    ];
