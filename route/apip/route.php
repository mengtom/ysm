...
Route::group(function (){
    Route::post('orderAdd/:order_sn','crm.CrmOrderController/create')->name('orderAdd');    //订单新增
    Route::post('order/take/:order_sn', 'crm.CrmOrderController/take')->name('orderTake'); //订单收货
    Route::get('microchipList','microchip.MicrochipController/list')->name('microchipList'); //微片列表
})->middleware(\app\http\middleware\AllowOriginMiddleware::class)->middleware(\app\http\middleware\AuthPTokenMiddleware::class,true);
