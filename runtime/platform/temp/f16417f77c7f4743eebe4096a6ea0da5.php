<?php /*a:4:{s:60:"F:\WWW\yeshai\app\platform\view\ts\ts\microchip_selected.php";i:1604306999;s:49:"F:\WWW\yeshai\app\platform\view\public\header.php";i:1596013767;s:49:"F:\WWW\yeshai\app\platform\view\public\footer.php";i:1592563283;s:55:"F:\WWW\yeshai\app\platform\view\public\inner_footer.php";i:1595304974;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
						...
						<div class="mt-10 items1" style="width: 754px;margin: auto">
							...
							<div class="">
								<div v-for="(i,k) in items1" class="w-100  d-flex align-items-center justify-content-start" style="height: 38px;border-bottom: 1px solid #f9f9f9;">
                                    ...
                                    <div class="w-100px ellipsis-1" :title='i.status === 1'>{{i.status === 1 ? "可用":"不可用"}}</div>
...
<!--:data-id="m.micro_id" :data-kind="m.ts_id" :data-name="m.name_zn" :data-scope="m.dose_range" :data-maxnum="m.day_max" :data-unit="m.unit"-->
			...
			<i
					:data-name="i.zn_name" :data-id="i.micro_id" :data-kind="i.micro_id" :data-scope="i.dose" :data-maxnum="i.dose_max" :data-unit="i.unit"
