<?php /*a:6:{s:57:"F:\WWW\yeshai\app\platform\view\crm\institution\order.php";i:1603878471;s:49:"F:\WWW\yeshai\app\platform\view\public\header.php";i:1596013767;s:58:"F:\WWW\yeshai\app\platform\view\public\header_navigate.php";i:1602238877;s:49:"F:\WWW\yeshai\app\platform\view\public\footer.php";i:1592563283;s:55:"F:\WWW\yeshai\app\platform\view\public\inner_footer.php";i:1595304974;s:53:"F:\WWW\yeshai\app\platform\view\public\layui_page.php";i:1595310927;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
 ...
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 cmr-order" id="app">
		...
		<div class="w-1200 mt-80 mb-10  text-666 size-14">
			<a class="text-57">首页 /</a> <a href="index.html" class="text-57">机构管理 </a> <span class="text-c01f5e">/ 查看机构订单 </span>
		</div>
						...
						<div v-for="i in items" class="w-100 d-flex align-items-center justify-content-start flex-column t-tabl-top">
							...
							<div class="w-100 d-flex align-items-center justify-content-start t-tabl-top-centen">
								...
								<div class="h-100 d-flex align-items-center justify-content-center w-90px flex-column bl">
									...
									<span class="w-100 text-center text-27"><a :href=`<?php echo Url('order_details'); ?>?id=${i.id}&i_id=<?php echo htmlentities($id); ?>` class="text-c01f5e">查看详情</a></span>
								</div>
