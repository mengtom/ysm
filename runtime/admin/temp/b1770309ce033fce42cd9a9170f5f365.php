<?php /*a:4:{s:61:"F:\WWW\yeshai\app\admin\view/ysm\ts\ts\microchip_selected.php";i:1604306999;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\header.php";i:1594957768;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\footer.php";i:1592563283;s:56:"F:\WWW\yeshai\app\admin\view/ysm\public\inner_footer.php";i:1603854727;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
						...
						<div class="mt-10 items1" style="width: 754px;margin: auto">
							...
							<div class="">
								<div v-for="(i,k) in items1" class="w-100  d-flex align-items-center justify-content-start" style="height: 38px;border-bottom: 1px solid #f9f9f9;">
									...
									<div class="w-100px ellipsis-1" :title="i.is_show">{{i.is_show === 1 ? "可用":"不可用"}}</div>
...
<!--:data-id="m.micro_id" :data-kind="m.ts_id" :data-name="m.name_zn" :data-scope="m.dose_range" :data-maxnum="m.day_max" :data-unit="m.unit"-->
			...
			<i
					...
					data-val="1" :data-dosage="i.dose" :data-dosage1="i.dose" :data-rmbprice="i.price" :data-is_show="i.is_show" :data-is_status="i.is_show" :data-usdprice="i.usd" :data-type="1" :data-pid="i.id"
