<?php /*a:6:{s:69:"F:\WWW\yeshai\app\admin\view/ysm\microchip\microchip_product\edit.php";i:1604903035;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\header.php";i:1594957768;s:59:"F:\WWW\yeshai\app\admin\view/ysm\public\header_navigate.php";i:1594196211;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\footer.php";i:1592563283;s:56:"F:\WWW\yeshai\app\admin\view/ysm\public\inner_footer.php";i:1603854727;s:54:"F:\WWW\yeshai\app\admin\view/ysm\public\layui_page.php";i:1603854936;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
...
<div id="app" class="wp-edit">
	...
	<div class="w-1200  wp-edit pb-10 mb-30" style="border-radius: 1px;  background-color: #ffffff;">
		<form class="layui-form" action="<?php echo url('update',array('id'=>$id)); ?>" method="post" multiple>
			<div class="wp-edit-body  h-100 pt-20">
				...
				<div class="items w-100">
						...
						<div class=" w-100">
							<div class="ivu-select  ivu-select-single ivu-select-default relative w-200px">
								<select name="cate_id" class="w-200px" lay-verify="required">
									...
									<option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $info['cate_id']): ?> selected="selected" <?php endif; ?>><?php echo htmlentities($vo['html']); ?><?php echo htmlentities($vo['title']); ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
					...
					<div class="item w-100 ">
						...
						<div class=" w-100">
							<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="code" value="<?php echo htmlentities($info['code']); ?>">
						</div>
					</div>
					...
					<div class="item  w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="zn_name" value="<?php echo htmlentities($info['zn_name']); ?>">
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Name</div>
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="en_name" value="<?php echo htmlentities($info['en_name']); ?>">
							</div>
						</div>
					</div>
					...
					<div class="item w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="scientific_zn_name" value="<?php echo htmlentities($info['scientific_zn_name']); ?>">
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Scientific name</div>
							<div class="w-100">
								<input style="width: 400px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="scientific_en_name" value="<?php echo htmlentities($info['scientific_en_name']); ?>">
							</div>
						</div>
					</div>
					...
					<div class="item w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="microchip_info_zn" ><?php echo htmlentities($info['microchip_info_zn']); ?></textarea>
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Product description</div>
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="microchip_info_en"><?php echo htmlentities($info['microchip_info_en']); ?></textarea>
							</div>
						</div>
					</div>
					...
					<div class="item w-100 d-flex align-items-center justify-content-start  ">
						<div>
							...
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="effects_zn"><?php echo htmlentities($info['effects_zn']); ?></textarea>
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Side effects</div>
							<div class="w-100">
								<textarea style="width: 400px;height: 67px;" type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0" name="effects_en"><?php echo htmlentities($info['effects_en']); ?></textarea>
							</div>
						</div>
					</div>
					...
					<div class = "item w-100 d-flex align-items-center justify-content-start  ">
						<div >
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "w-190px">
									<input type = "text" class = "ivu-input w-100 weight" placeholder = "请输入数字" name="weight" value="<?php echo htmlentities($info['weight']); ?>">
								</div>
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-150px">
										<span v-show="!cogeditshow">
											<span>￥</span>
											<span class = "cogtotalrmbprice"><?php echo htmlentities($info['cost_rmb']); ?></span>
										</span>
									<span v-show="cogeditshow">
											 <div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-150px">
		                                        <input autocomplete = "off"  spellcheck = "false" type = "text" placeholder = "RMB" class = "ivu-input ivu-input-default ivu-input-with-prefix cogtotalrmbpriceinput" name="cost_rmb" value="<?php echo htmlentities($info['cost_rmb']); ?>">
								...
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text text-27 w-150px">
										<span v-show="!cogeditshow">
											<span>$</span>
											<span class = "cogtotalusdprice"><?php echo htmlentities($info['cost_usd']); ?></span>
										</span>
									<span v-show="cogeditshow">
											 <div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-150px">
		                                        <input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix cogtotalusdpriceinput" name="cost_usd" value="<?php echo htmlentities($info['cost_usd']); ?>">
								...
								<!--<input id="coginput" class="hide" type="radio" lay-ignore name="coginput" value="1"   >-->
								...
								<input id="coginput" name="coginput" class="hide" type="radio" lay-ignore value="<?php echo htmlentities($info['pricinginput']); ?>">
								<label  @click="cogedit()" for="coginput"   class = "ml-10 text-c01f5e cursor">编辑</label>
							</div>
						</div>
					</div>
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-150px">
										<span v-show="!pricingshow">
											<span>￥</span>
											<span class = "pricingpricermb"><?php echo htmlentities($info['pricing_rmb']); ?></span>
										</span>
									<span v-show="pricingshow">
											<!--<input type = "text" placeholder = "请输入" class = "ivu-input w-100 pricingpricermbinput">-->
											<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-150px">
		                                        <input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix pricingpricermbinput" name="pricing_rmb" value="<?php echo htmlentities($info['pricing_rmb']); ?>">
		                                        <span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-yen" style = "color: #272727;font-size: 14px;"></i></span>
											 </div>
										</span>
								</div>
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text text-27 w-150px">
										<span v-show="!pricingshow">
											<span>$</span>
											<span class="pricingpriceusd" ><?php echo htmlentities($info['pricing_usd']); ?></span >
										</span>
									<span v-show="pricingshow" >
											<!--<input type = "text" placeholder = "请输入" class = "ivu-input w-100 pricingpriceusdinput">-->
											<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-150px">
		                                        <input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix pricingpriceusdinput" name="pricing_usd" value="<?php echo htmlentities($info['pricing_usd']); ?>">
		                                        <span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-usd" style = "color: #272727;font-size: 14px;"></i></span>
											</div>
										</span>
								</div>
								<!--编辑后不再统计值，反之着统计-->
								<!--<label @click="pricingedit()" for="pricinginput"  class = "ml-10 text-c01f5e cursor">编辑</label>-->
								<!--<input id="pricinginput" class="hide" type="radio" lay-ignore name="pricinginput" value="1"   >-->
								...
								<input id="pricinginput" class="hide" type="radio" lay-ignore value="<?php echo htmlentities($info['pricinginput']); ?>" name='pricinginput'>
						...
						<div>
							...
							<div class = "w-100 d-flex align-items-center justify-content-start">
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
									<input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "RMB" class = "ivu-input ivu-input-default ivu-input-with-prefix" name="price" value="<?php echo htmlentities($info['price']); ?>">
									<span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-yen" style = "color: #272727;font-size: 14px;"></i></span>
								</div>
								<div class = "ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text w-190px">
									<input autocomplete = "off" spellcheck = "false" type = "text" placeholder = "USD" class = "ivu-input ivu-input-default ivu-input-with-prefix" name="usd" value="<?php echo htmlentities($info['usd']); ?>">
									<span class = "ivu-input-prefix"><i class = "ivu-icon ivu-icon-logo-usd" style = "color: #272727;font-size: 14px;"></i></span>
								</div>
							</div>
				...
				<div class="items w-100">
					...
					<div class="w-100 d-flex align-items-center justify-content-start flex-column  hxcflist">
						<!-- hxcfitem w-100 d-flex align-items-center justify-content-around" style="height: 40px;" -->
						<div class="w-100 mt-10 hxcflistitems">
							<?php if(is_array($info['ingredient']['0']) || $info['ingredient']['0'] instanceof \think\Collection || $info['ingredient']['0'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['ingredient']['0'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<div class="hxcfitem w-100 d-flex align-items-center justify-content-around"  style="height: 40px;">
								<!--编辑新增-->
								<span class="hide cfsingledata" data-name='<?php echo htmlentities($vo['name']); ?>' data-code="<?php echo htmlentities($vo['code']); ?>" data-dose="<?php echo htmlentities($vo['dose']); ?>" data-unit="<?php echo htmlentities($vo['unit']); ?>" data-rmbprice='<?php echo htmlentities($vo['price_rmb']); ?>' data-usdprice='<?php echo htmlentities($vo['price_usd']); ?>'></span>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[<?php echo htmlentities($vo['ingredient_id']); ?>][name]" type="hidden" value="<?php echo htmlentities($vo['name']); ?>">
									<?php echo htmlentities($vo['name']); ?>
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[<?php echo htmlentities($vo['ingredient_id']); ?>][code]" type="hidden" value="<?php echo htmlentities($vo['code']); ?>">
									<?php echo htmlentities($vo['code']); ?>
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[<?php echo htmlentities($vo['ingredient_id']); ?>][dose]" type="hidden" value="<?php echo htmlentities($vo['dose']); ?>" oninput = " value=value.replace(/[^\d.]/g,'')" >
									<?php echo htmlentities($vo['dose']); ?>
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ">
									<input name="ingre1[<?php echo htmlentities($vo['ingredient_id']); ?>][unit]" type="hidden" value="<?php echo htmlentities($vo['unit']); ?>">
									<?php echo htmlentities($vo['unit']); ?>
								</div>
						...
						<div class="w-100 mt-10 d-flex align-items-center justify-content-around hxcfitem" style="height: 40px;">
							...
							<div class="ivu-select  ivu-select-single ivu-select-default relative ml-10 mr-10 w-200px">
								<select class="w-200px cfcode" lay-filter="test4" lay-verify="required" lay-search="">
									...
									<!--data-rmbprice="1" 代表该批次的人民币价格 data-usdprice="<?php echo htmlentities($h['price_rmb']); ?>" 代表该批次的美元价格 -->
									<?php if(is_array($huo_micro) || $huo_micro instanceof \think\Collection || $huo_micro instanceof \think\Paginator): $i = 0; $__LIST__ = $huo_micro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$h): $mod = ($i % 2 );++$i;?>
				...
				<div class="items w-100">
					...
					<div class="w-100 d-flex align-items-center justify-content-start flex-column  fllist">
						...
						<div class="w-100 mt-10 fllistitems">
							<?php if(is_array($info['ingredient']['1']) || $info['ingredient']['1'] instanceof \think\Collection || $info['ingredient']['1'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['ingredient']['1'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<div class="hxcfitem w-100 d-flex align-items-center justify-content-around"  style="height: 40px;">
								<!--编辑新增-->
								<span class="hide flsingledata" data-name='<?php echo htmlentities($vo['name']); ?>' data-code="<?php echo htmlentities($vo['code']); ?>" data-dose="<?php echo htmlentities($vo['dose']); ?>" data-unit="<?php echo htmlentities($vo['unit']); ?>" data-rmbprice='<?php echo htmlentities($vo['price_rmb']); ?>' data-usdprice='<?php echo htmlentities($vo['price_usd']); ?>'></span>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[<?php echo htmlentities($vo['ingredient_id']); ?>][name]" type="hidden" value="<?php echo htmlentities($vo['name']); ?>">
									<?php echo htmlentities($vo['name']); ?>
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[<?php echo htmlentities($vo['ingredient_id']); ?>][code]" type="hidden" value="<?php echo htmlentities($vo['code']); ?>">
									<?php echo htmlentities($vo['code']); ?>
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[<?php echo htmlentities($vo['ingredient_id']); ?>][dose]" type="hidden" value="<?php echo htmlentities($vo['dose']); ?>" >
									<?php echo htmlentities($vo['dose']); ?>
								</div>
								<div class="w-200px d-flex align-items-center justify-content-start ml-20">
									<input name="ingre2[<?php echo htmlentities($vo['ingredient_id']); ?>][unit]" type="hidden" value="<?php echo htmlentities($vo['unit']); ?>">
									<?php echo htmlentities($vo['unit']); ?>
								</div>
								<div class="d-flex align-items-center justify-content-start ml-20" style="width: 150px;">
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
						...
						<div class="w-100 mt-8">
							<div class="ivu-select  ivu-select-single ivu-select-default relative w-400px">
								<select name="unit" lay-verify="required">
									<option value="">请选择</option>
									<option value="iu" <?php if($info['unit'] == 'iu'): ?>selected="selected"<?php endif; ?>>iu</option>
									<option value="mg" <?php if($info['unit'] == 'mg'): ?>selected="selected"<?php endif; ?>>mg</option>
									<option value="ml" <?php if($info['unit'] == 'ml'): ?>selected="selected"<?php endif; ?>>ml</option>
									<option value="mcg"<?php if($info['unit'] == 'mcg'): ?>selected="selected"<?php endif; ?>>mcg</option>
								</select>
							</div>
						</div>
					</div>
					<div style="margin-left: 50px;">
						...
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" lay-verify="number" placeholder="请输入数字" class="ivu-input ml0" name="day_max" value="<?php echo htmlentities($info['day_max']); ?>">
						</div>
					</div>
				</div>
				...
				<div class="item mt-20 w-100 d-flex align-items-center justify-content-start  ">
					<div>
						...
						<div class="w-100 mt-8 d-flex align-items-center justify-content-center">
							<input type="text" placeholder="请输入最小值" class="ivu-input mr-20 w-190px" name="dose_min" value="<?php echo htmlentities($info['dose_min']); ?>">
							<input type="text" placeholder="请输入最大值" class="ivu-input w-190px" name="dose_max" value="<?php echo htmlentities($info['dose_max']); ?>">
						</div>
					</div>
					<div style="margin-left: 50px;">
						<div class=" size-14 item-text">剂量显示/单次增量<span class="text-ff4d4f">*</span></div>
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" placeholder="请输入数字" class="ivu-input ml0" name="dose" value="<?php echo htmlentities($info['dose']); ?>">
						</div>
					</div>
				</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
					<div>
						...
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" class="ivu-input" placeholder="由中文/英文/数字/符号组成" name="facts_name" value="<?php echo htmlentities($info['facts_name']); ?>">
						</div>
					</div>
					<div style="margin-left: 50px;">
						<div class=" size-14 item-text">%Daily Value<span class="text-ff4d4f">*</span></div>
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="text" class="ivu-input" placeholder="请输入数字"  name="facts_daily" value="<?php echo htmlentities($info['facts_daily']); ?>">
						</div>
					</div>
				</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
					<div style="width: 230px;">
						...
						<div class="w-100 mt-8">
							<input type="text" class="ivu-input" placeholder="请输入数字"  name="amount" value="<?php echo htmlentities($info['amount']); ?>">
						</div>
					</div>
						...
						<div class="w-100 mt-8">
							<div class="ivu-select  ivu-select-single ivu-select-default relative " style="width: 150px;">
								<select name="facts_unit" class="w-200px" lay-verify="required">
									...
									<option value="iu" <?php if($info['facts_unit'] == 'iu'): ?>selected="selected"<?php endif; ?>>iu</option>
									<option value="mg" <?php if($info['facts_unit'] == 'mg'): ?>selected="selected"<?php endif; ?>>mg</option>
									<option value="ml" <?php if($info['facts_unit'] == 'ml'): ?>selected="selected"<?php endif; ?>>ml</option>
									<option value="mcg"<?php if($info['facts_unit'] == 'mcg'): ?>selected="selected"<?php endif; ?>>mcg</option>
								</select>
							</div>
						</div>
					</div>
					<div style="margin-left: 50px;">
						...
						<div class="w-100 mt-8">
							<input style="width: 400px;" type="number" class="ivu-input" placeholder="请输入数字"  name="facts_sort" value="<?php echo htmlentities($info['facts_sort']); ?>">
						</div>
					</div>
				</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start  ">
					<textarea rows="7" style="width: 850px;" placeholder="请输入" class="ivu-input" name="references"><?php echo htmlentities($info['references']); ?></textarea>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start ">
					<div class="cursor d-flex align-items-center justify-content-center flex-column filesft">
						<input id="image_input" type="text" class="hide" name="image" maxlength="1" value="<?php echo htmlentities($info['image']); ?>">
						<!--上传前-->
						...
						<span class="w-100 h-100 imgupdata">
								<span class="relative w-100 h-100 d-flex align-items-center justify-content-center">
									<img class="absolute w-100 image_img" <?php if($info['image']): ?> src="<?php echo htmlentities($info['image']); ?>" <?php else: ?>src="/ysm/static/images/zimg-logo.png" <?php endif; ?>alt="">
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start flex-column">
					<div class="w-100 d-flex align-items-center justify-content-start">
						<label class="ivu-btn ivu-btn-default d-flex align-items-center justify-content-center">
							...
							上传文件
							<input type="file" multiple class="hide upfile">
						</label>
					...
					<div class="mt-8 w-100 basic-updata-items" style="">
						...
						<div class="basic-updata-item">
							<div class="relative w-100">
								...
								<input type="hidden" name="files[]" value="<?php echo htmlentities($f['path']); ?>">
							</div>
						</div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				...
				<div class="item w-100 mt-20 d-flex align-items-center justify-content-start " style="margin-bottom: 30px;">
					<button class="ivu-btn-primary ivu-btn mr-20" type="submit">编辑微片</button>
...
<script type="text/javascript">
	var app = new Vue({
		...
		data   : {
			...
			ismodel  : false,
			cf       : '',
			model18  : ["<?=implode('","',explode(',',$info['cate2']))?>"],
			model19  : ["<?=$info['cate3'] ?? implode('","',explode(',',$info['cate3']))?>"],
			model20  : [],
			model21  : [],
			model25  : [],
			model26  : [],
...
<script>
	...
	$('.imgdelete').click(function () {
		$('#image_input').attr('value','');
		$(".image_img").attr('src','/ysm/static/images/zimg-logo.png');
	});
	...
	$('.add-hxcf').click(function (e) {
		...
		var html = '<div class="hxcfitem w-100 d-flex align-items-center justify-content-around" style="height: 40px;">' +
			...
			'<input value="' + cftext + '"  name="ingre1['+cf+'][name]" type="hidden">' +
			cftext +
			'</div>' +
			'<div class="w-200px d-flex align-items-center justify-content-start ml-10 mr-10 text-57">' +
