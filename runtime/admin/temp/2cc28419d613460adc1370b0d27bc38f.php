<?php /*a:5:{s:47:"F:\WWW\yeshai\app\admin\view/ysm\ts\ts\edit.php";i:1604306999;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\header.php";i:1594957768;s:59:"F:\WWW\yeshai\app\admin\view/ysm\public\header_navigate.php";i:1594196211;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\footer.php";i:1592563283;s:56:"F:\WWW\yeshai\app\admin\view/ysm\public\inner_footer.php";i:1603854727;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
					...
					<div class="items pl-30 w-100">
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start  ">
							<div>
								...
								<div class="w-100">
									<input type="text" placeholder="由中文/英文/数字/符号组成" class="ivu-input w-400px ml0" name="name_zn"  value="<?php echo htmlentities($info['name_zn']); ?>">
								</div>
							</div>
							<div style="margin-left: 40px;">
								<div class=" size-14 item-text">Name</div>
								<div class="w-100">
									<input type="text" placeholder="由英文/数字/符号组成" class="ivu-input w-400px ml0" name="name_en" value="<?php echo htmlentities($info['name_en']); ?>">
								</div>
							</div>
						</div>
...
<script type="text/javascript">
		...
		data   : {
			...
			hxcflistdata:[
				<?php if(is_array($microchip) || $microchip instanceof \think\Collection || $microchip instanceof \think\Paginator): $i = 0; $__LIST__ = $microchip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
				{
					...
					usdprice : '<?php echo htmlentities($v['usd']); ?>',
					val      : '<?php echo htmlentities($v['num']); ?>',
					is_status: '<?php echo htmlentities($v['is_status']); ?>',
				},
				<?php endforeach; endif; else: echo "" ;endif; ?>
			],
			factsdata   : [],
    ...
    */
    $('.facts').click(function () {
        ...
        //先清空数据
        // app.$data.factsdata = [];
        axios.post('<?php echo Url("supplement"); ?>', {data: arr}).then(function (e) {
            if (e) {
