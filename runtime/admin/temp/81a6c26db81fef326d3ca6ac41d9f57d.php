<?php /*a:6:{s:59:"F:\WWW\yeshai\app\admin\view/ysm\crm\crm_platform\order.php";i:1603878290;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\header.php";i:1594957768;s:59:"F:\WWW\yeshai\app\admin\view/ysm\public\header_navigate.php";i:1594196211;s:50:"F:\WWW\yeshai\app\admin\view/ysm\public\footer.php";i:1592563283;s:56:"F:\WWW\yeshai\app\admin\view/ysm\public\inner_footer.php";i:1603854727;s:54:"F:\WWW\yeshai\app\admin\view/ysm\public\layui_page.php";i:1603854936;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
 ...
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 cmr-order" id="app">
		...
		<div class="w-1200 mt-80 mb-10 tip  text-666 size-14">
			<a class="text-57">首页 /</a> <a href="index.html" class="text-57">平台管理 </a> <span class="text-c01f5e">/ 查看平台订单 </span>
		</div>
			...
			<div class="w-100 label-list bg-fff">
				<div class="w-100 list-title d-flex align-items-center justify-content-between mb-20 pt-20">
					<span class="size-16  ml-20">
						...
						<span class="size-14">（<?php echo htmlentities($platform['p_name']); ?>）</span>
					</span>
					<div>
						...
						<div v-for="i in items" class="w-100 d-flex align-items-center justify-content-start flex-column t-tabl-top">
							...
							<div class="w-100 d-flex align-items-center justify-content-start t-tabl-top-centen">
								...
								<div class="h-100 d-flex align-items-center justify-content-center w-90px flex-column bl">
									...
									<span class="w-100 text-center text-27"><a :href=`<?php echo Url('order_details'); ?>?id=${i.id}&p_id=<?php echo htmlentities($id); ?>` class="text-c01f5e">查看详情</a></span>
								</div>
								<div class="h-100 d-flex align-items-center justify-content-center flex-column w-90px bl">

									<button v-if="i._status == 2 && i.shipping_type==1" type="button"  class="ivu-btn ivu-btn-primary ivu-btn-small mt-8 shipments" style="width: 72px;">发货</button>
									<button v-if="i._status == 1" type="button"  class="ivu-btn ivu-btn-default ivu-btn-small mt-8 failed" style="width: 72px;">报关失败</button>
...
<script type="text/javascript">
	...
	var app   = new Vue({
		...
		methods: {
	        ...
	        excel:function () {
	            this.where.excel=1;
	            location.href=layList.U({c:'crm.crm_platform',a:'order_list',q:this.where});
	        },
			// 页码改变的回调，返回改变后的页码
			pagechange(e) {
				this.pagenum = e;
