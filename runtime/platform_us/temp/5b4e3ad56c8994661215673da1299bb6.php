 ...
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 crm-patient-p" id="app">
		...
		<div class="w-1200 mt-80 mb-10 text-666 size-14">
			<a class="text-57">Home /</a><a href="index.html" class="text-57"> Cooperation Organization Management /</a> <span class="text-c01f5e">Subordinate patients </span>
		</div>
		<!--搜索区-->
			...
			<div class="keyword w-100  h-auto">
				<form class="w-100 h-100 layui-form  d-flex align-items-start justify-content-between" action="" method="get">
					...
					<div class="h-100 w-auto pl-20 d-flex align-items-center justify-content-start flex-wrap mt-20 mb-20">
						...
						<div class="h-100 w-300px mr-30 mb-10">
							<div class="w-100">Patient information</div>
								<input class="ivu-input w-100 mt-8"  placeholder="请输入" type="text" v-model="keyword">
							</div>
						<div class="h-100 w-300px mr-30 mb-10">
							<div class="w-100">Register time</div>
							<div class="w-100 mt-8">
								<input class="ivu-input" type="text" placeholder="Star → End" style="width: 240px;" id="test13" v-model="time">
							</div>
						</div>
					</div>
					...
					<div class="w-25 h-100 mt-20  d-flex align-items-start justify-content-end ">
						...
						<button type="button" class="ivu-btn ivu-btn-primary mr-10 mt-20" @click="getitems">Filter</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="w-1200 label-list mt-20 mb-30 bg-fff">
			<div class="w-100 list-title d-flex align-items-center justify-content-between mb-20 pt-20">
				<span class="size-16  ml-20"><span class="fw">Subordinate Patients List</span>(Company Name) </span>
			</div>
			...
			<div class="w-100 table ">
				...
				<table class="ivu-table  ivu-table-default entbableth" style="overflow: initial">
					...
					<tr class="ivu-table-header cursor">
						<th class="pl-30 bg-f6 text-center w-70px">No.</th>
						<th class="bg-f6 w-100px">Name</th>
						<th class="bg-f6 w-150px">Contact number</th>
						<th class="bg-f6 w-100px">Register time</th>
						<th class="bg-f6 w-150px">Affiliated organization/doctor</th>
						<th class="bg-f6 w-100px">Number of Scripts</th>
