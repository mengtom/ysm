<?php /*a:5:{s:51:"F:\WWW\yeshai\app\platform_us\view\ts\ts\create.php";i:1606303961;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1606294604;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
				...
				<div class="wp-edit-body h-100 pt-20 bg-fff" style="width: 900px;margin: initial">
					...
					<div class="items pl-30 w-100">
						<div class="item w-100 ">
							...
							<div class=" w-100">
								<input type="text" placeholder="English/Numbers/Symbols" class="ivu-input ml0 w-400px" name="code">
							</div>
						</div>
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start  ">
							<div>
								...
								<div class="w-100">
									<input type="text" placeholder="English/Numbers/Symbols" class="ivu-input w-400px ml0" name="name_en">
								</div>
							</div>
						</div>
					...
					<div class="item w-100 pl-30 mt-20 d-flex align-items-start justify-content-start">
						<div>
							...
							<div class="w-100 mt-8">
								<textarea rows="3" placeholder="Please enter" class="ivu-input w-400px" name="description"></textarea>
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">Reference</div>
							<div class="w-100 mt-8">
								<textarea rows="3" placeholder="Please enter" class="ivu-input w-400px" name="reference"></textarea>
							</div>
						</div>
					</div>
