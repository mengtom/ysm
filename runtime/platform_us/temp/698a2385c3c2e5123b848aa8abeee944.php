<?php /*a:6:{s:66:"F:\WWW\yeshai\app\platform_us\view\crm\crm_order\order_details.php";i:1606126584;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;s:56:"F:\WWW\yeshai\app\platform_us\view\public\layui_page.php";i:1595310927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!-- <script>
 $eb = parent._mpApi;
	...
	<div id="app" class="order-details-p">
		<!--头部-->
		<!--头部-->
		...
		<div class="w-1200 mt-80 mb-10 tip  text-666 size-14">
			...
			<a href="order.html" class="text-57">Orders Managment/</a>
			...
			<form class="layui-form" action="">
				<div class="wp-edit-body  h-100 pt-20">
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-10 ivu-table-wrapper ivu-table-wrapper-with-border">
							<table class="ivu-table  ivu-table-default ivu-table-border" style="overflow: initial">
								...
								<tr>
									<td class="text-center text-57 t-table-td"><?php echo htmlentities($m['micro_code']); ?></td>
						...
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
							<div class="w-200px">Types of microtabs：<?php echo htmlentities($order['micro_cate_count']); ?></div>
							<div class="w-200px ml-10">Total number of microtabs：<?php echo htmlentities($order['micro_count']); ?></div>
						</div>
						...
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
							<div class="w-200px">Number of daily taking times：<?php echo htmlentities($order['taking_quency']); ?></div>
						...
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
							<div class="size-14 item-text w-400px d-flex align-items-start justify-content-start">
								<div class="h-100" style="width: 45px;">Medical Order：</div>
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
							<div class="size-14 item-text w-400px d-flex align-items-start justify-content-start">
								<div class="h-100" style="width: 85px;">Refund reason:</div>
							...
							<div class="size-14 item-text w-400px d-flex align-items-start justify-content-start ml-50">
								<div class="h-100" style="width: 85px;">Refund instructions:</div>
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-10 d-flex align-items-center justify-content-start">
							...
							<div class="size-14 item-text w-400px ml-50">Customs clearance number：XXXXXXXXXXXXXXXX</div>
						</div>

						<div class="w-100 mt-10 d-flex align-items-center justify-content-start">
							<div class="size-14 item-text w-400px">ID number：010111111111111111</div>
							<div class="size-14 item-text w-400px ml-50">Customs clearance status：通过</div>
						</div>
						...
						<div class="w-100 mt-10">
							<div class="d-flex align-items-start justify-content-start w-400px">
								<div class="h-100" style="width: 85px;">Address：</div>
						...
						<div class="w-100 mt-10">
							<div class="d-flex align-items-start justify-content-start">
								<div class="h-100 w-100px" style="width: 75px;">Logistics tracking：</div>
								<div class="w-100 d-flex align-items-start flex-column justify-content-start">
									...
									<div><a href="" class="text-c01f5e">More information</a></div>
								</div>
							</div>
							<div></div>
						</div>
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-10 ivu-table-wrapper ivu-table-wrapper-with-border">
							<table class="ivu-table  ivu-table-default ivu-table-border" style="overflow: initial">
								...
								<tr>
									<td class="text-center text-57 t-table-td" >XXXXXXXXXXXXX</td>
									<td class="text-center text-57 t-table-td" >Microtabs name</td>
									<td class="text-center text-57 t-table-td" >0000</td>
									<td class="text-center text-57 t-table-td" >0000</td>
									<td class="text-center text-57 t-table-td" >0000</td>
								</tr>
								<tr>
						...
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
							<div class="w-400px">Settlement price(single dose)：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Packaging settlement price(single dose) ：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Cylindrical packaging settlement price：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Outer packaging settlement price：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Logistics settlement price：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<!--（单剂结算价格+Packaging settlement price(single dose) ）每日次数周期+筒形包装*周期/10+Outer packaging settlement price+物流结算价格-->
							<div class="w-400px">Total order settlement price：<span>1111111</span></div>
						</div>

						<div class="w-100 mt-20">
							<div class="w-400px fw">Order source tracing</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Cooperation Platform：XXX元</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Organization name：XXX元</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Doctor's name：XXX元</div>
						</div>
