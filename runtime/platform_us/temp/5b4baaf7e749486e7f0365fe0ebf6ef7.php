<?php /*a:5:{s:61:"F:\WWW\yeshai\app\platform_us\view\crm\institution\create.php";i:1606103046;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
 ...
 $eb = parent._mpApi;
	...
	<div id="app" class="crm-edit-p">
		...
		<div class="w-1200 tip mt-80  text-666 size-14">
			<span>Home /</span> <a class="text-57" href="<?php echo Url('crm.institution/index'); ?>">Cooperation Organization Management </a> <span class="text-c01f5e">/ Add Organization </span>
		</div>

		<div class="w-1200 mt-10 mb-10 tip  text-666 size-14">
			<span class="fw size-20 text-333">Add Organization</span>
		</div>
				...
				<div class="wp-edit-body  h-100 pt-20">
					<div class="items w-100">
						<div class="item w-100">
							...
							<div class=" w-100">
								<input type="text" name="name" placeholder="English/Numbers/Symbols" class="ivu-input ml0 w-400px">
							</div>
						</div>
						...
						<div class="item  w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input type="text" name="account" placeholder="8-16characters,English/Numbers/Symbols" class="ivu-input ml0  w-400px">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class=" size-14 item-text">Password<span class="text-ff4d4f">*</span></div>
								<div class="w-100">
									<i-input class="w-400px" v-model="value5" name="password" type="password" password placeholder="8-16characters,English/Numbers/Symbols"/>
								</div>
							</div>
						</div>
						...
						<div class="item w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input type="text" name="referrer" placeholder="English/Numbers/Symbols" class="ivu-input ml0 w-400px">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class="w-100 d-flex align-items-center justify-content-start">
									<div>
										...
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input type="text" name="refer_mobile" placeholder="Numbers/Symbols" class="ivu-input w-190px ml0">
										</div>
									</div>
									<div>
										<div class=" size-14 item-text">E-mail</div>
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input type="text" name="refer_email" placeholder="English/Numbers/Symbols" class="w-190px ivu-input ml0">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="item w-100 d-flex align-items-center justify-content-start">
							<div>
								...
								<div class="w-100">
									<input type="text" name="ecp" placeholder="English/Numbers/Symbols" class="ivu-input ml0  w-400px">
								</div>
							</div>
							<div style="margin-left: 50px;">
								<div class="w-100 d-flex align-items-center justify-content-start">
									<div>
										...
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input type="text" name="ecm" placeholder="Numbers/Symbols" class="ivu-input ml0 w-190px">
										</div>
									</div>
									<div>
										<div class=" size-14 item-text">E-mail</div>
										<div class="ivu-input-wrapper ivu-input-wrapper-default ivu-input-type-text mr-20 w-190px">
											<input type="text" name="ece" placeholder="English/Numbers/Symbols" class="ivu-input ml0 w-190px">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="item w-100 d-flex align-items-center justify-content-start">
							<div>
								<div class="size-14 item-text">Select group</div>
								<div class="w-400px">
						...
						<div>
							...
							<div class="w-400px mt-10">
								<label>
									...
									<input accept="*.jpg,*.png,*.jepg,*.JPG,*.PNG,*.JEPG,*.pdf,*.PDF" multiple type="file" class="hide upfile">
								</label>
					...
					<div class="item w-100 mt-20 d-flex align-items-center justify-content-start mb-30">
						...
						<button class="ivu-btn-primary ivu-btn mr-20" type="submit">Add Organization</button>
