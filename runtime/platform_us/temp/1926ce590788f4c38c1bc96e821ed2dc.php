<?php /*a:5:{s:59:"F:\WWW\yeshai\app\platform_us\view\crm\crm_doctor\index.php";i:1606127072;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
 ...
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 crm-index-i-p" id="app">
		...
		<div class="w-1200 mt-80 mb-10 tip  text-666 size-14">
			<a class="text-57">Home /</a> <span class="text-c01f5e">Independent Doctors Management </span>
		</div>
		<!--搜索区-->
			...
			<div class="keyword w-100  h-auto">
				<form class="w-100 h-100 layui-form  d-flex align-items-start justify-content-between" action="">
					<div class="h-100  pl-20 d-flex align-items-center justify-content-start flex-column mt-20 mb-20">
						<div class="w-100 d-flex align-items-center justify-content-start">
							<div class="h-100 w-300px mr-30 mb-10">
								...
								<input class="ivu-input w-100 ml-8" placeholder="Please enter" type="text" v-model="keyword">
							</div>
							...
							<div class="h-100 w-300px mr-30 mb-10">
								...
								<div class="w-100 mt-8">
									<input class="ivu-input" type="text" placeholder="Star → End" id="test13" v-model="time">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="h-100 mt-20  d-flex align-items-start justify-content-end">
						<button type="reset" class="ivu-btn ivu-btn-default mr-20">Reset</button>
						<button type="button" class="ivu-btn ivu-btn-primary mr-10" @click="getitems">Filter</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="w-1200 label-list mt-20 mb-30 bg-fff">
			<div class="w-100 list-title d-flex align-items-center justify-content-between mb-20 pt-20">
				<span class="size-16 fw ml-20">
					<span>Independent Doctors List</span>
					<a href="<?php echo Url('setting'); ?>" class="size-14 text-c01f5e ml-10"><i class="icon iconfont iconshezhi"></i> Setting</a>
				</span>
				<div>
					<a href="<?php echo Url('create'); ?>" class="ivu-btn ivu-btn-primary mr-20"><i class="ivu-icon ivu-icon-md-add"></i>Add Doctor</a>
				</div>
			</div>
			<!--表格-->
			<div class="w-100 table">
				...
				<table class="ivu-table  ivu-table-default entbableth" style="overflow: initial">
					...
					<tr class="ivu-table-header cursor">
						...
						<th class="bg-f6 w-100px">Contact number</th>
						<th class="bg-f6 w-100px">Register time</th>
						<th class="bg-f6 w-100px">Scripts</th>
						<th class="bg-f6 w-100px">Completed orders</th>
						<th class="bg-f6 w-100px">Total turnover</th>
						<th class="bg-f6 w-100px">Patients</th>
						<th class="bg-f6 w-100px">Group</th>
						<th class="bg-f6 w-120px">Function</th>
					</tr>
