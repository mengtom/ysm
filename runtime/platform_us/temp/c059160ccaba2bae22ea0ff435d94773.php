<?php /*a:6:{s:60:"F:\WWW\yeshai\app\platform_us\view\crm\institution\order.php";i:1606120580;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;s:56:"F:\WWW\yeshai\app\platform_us\view\public\layui_page.php";i:1595310927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!-- <script>
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 crm-order-p-en" id="app">
		<!--头部-->
		<!--头部-->
		...
		<div class="w-1200 mt-80 mb-10  text-666 size-14">
			<a class="text-57">Home /</a> <a href="index.html" class="text-57">Cooperation Organization Management </a> <span class="text-c01f5e">/ View order </span>
		</div>
						...
						<div class="h-100 w-auto pl-20 d-flex align-items-center justify-content-start flex-wrap mt-20 mb-20">
							<div class="w-100 d-flex align-items-center justify-content-start">
								<div class="h-100 w-300px mr-30 mb-10">
									...
									<div class="h-100 w-250px mr-30 mb-10">
							...
							<div class="h-100 w-250px mr-30 mb-10">
								...
								<input class="ivu-input w-100 mt-8" type="text" placeholder="Star → End" id="test13" v-model="where.time">
							</div>
						</div>
			...
			<div class="w-100 label-list bg-fff">
				<div class="w-100 list-title d-flex align-items-center justify-content-between mb-20 pt-20">
					<span class="size-16  ml-20">
						<span class="fw">All orders</span>
						<span class="size-14">（<?php echo htmlentities($institu['name']); ?>）</span>
					</span>
				</div>
						...
						<div v-for="i in items" class="w-100 d-flex align-items-center justify-content-start flex-column t-tabl-top">
							...
							<div class="w-100 d-flex align-items-center justify-content-start t-tabl-top-centen">
								...
								<div class="h-100 d-flex align-items-center justify-content-center w-90px flex-column bl">
									...
									<span class="w-100 text-center text-27"><a :href=`<?php echo Url('order_details'); ?>?id=${i.id}&i_id=<?php echo htmlentities($id); ?>` class="text-c01f5e">Details</a></span>
								</div>
								<div class="h-100 d-flex align-items-center justify-content-center flex-column w-90px bl">
		...
		methods: {
			...
			getitems(e,type) {
				...
				var data = {
					...
					institu_id 		:<?php echo htmlentities($id); ?>,
