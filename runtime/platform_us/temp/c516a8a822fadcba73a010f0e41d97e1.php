<?php /*a:6:{s:62:"F:\WWW\yeshai\app\platform_us\view\crm\institution\setting.php";i:1606114320;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;s:56:"F:\WWW\yeshai\app\platform_us\view\public\layui_page.php";i:1595310927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
 ...
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 crm-setting-p" id="app">
		...
		<div class="w-1200 mt-80 mb-10 tip text-666 size-14">
			<a class="text-57">Home /</a> <a class="text-57" href="index.html">Cooperation Organization Management /</a> <span class="text-c01f5e">Cooperation Organization Setting </span>
		</div>
		<!--搜索区-->
		<div class="w-1200">
		...
		<div class="w-1200 label-list mt-20 mb-30 bg-fff">
			<div class="w-100 list-title d-flex align-items-center justify-content-between mb-20 pt-20">
				<span class="size-16 fw ml-20">Organization Group List</span>
				<div>
				...
				<form class="layui-form" action="<?php echo Url('setting'); ?>" method="post">
					<div class="items  d-flex align-items-center justify-content-start flex-column   ">
						<div class="item w-100 d-flex align-items-center justify-content-start flex-column">
							...
							<input type="text" name="commission" min="0" max="100" value="<?php echo htmlentities($scale['commission']); ?>" placeholder="Please enter" class="ivu-input ivu-input-default mt-8">
						</div>
						<div class="item w-100 d-flex align-items-center justify-content-start flex-column mt-20">
							<div class="w-100">Initial purchase discount<span class="text-ff4d4f">*</span></div>
							<input type="text" name="discount" min="0" max="10" value="<?php echo htmlentities($scale['discount']); ?>" placeholder="Please enter" class="ivu-input ivu-input-default mt-8">
						</div>
					</div>
					<div class="w-100 d-flex align-items-center justify-content-end foot ">
						<button type="reset" class="ivu-btn ivu-btn-default closemode">Cancel</button>
