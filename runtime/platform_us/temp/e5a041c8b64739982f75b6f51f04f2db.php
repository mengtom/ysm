<?php /*a:6:{s:67:"F:\WWW\yeshai\app\platform_us\view\crm\crm_doctor\order_details.php";i:1606213191;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;s:56:"F:\WWW\yeshai\app\platform_us\view\public\layui_page.php";i:1595310927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!-- <script>
 $eb = parent._mpApi;
	...
	<div id="app" class="crm-details-p">
		<!--头部-->
		<!--头部-->
		...
		<div class="w-1200 mt-80 mb-10 tip  text-666 size-14">
			...
			<a :href=`<?php echo Url('order'); ?>?id=<?php echo htmlentities($d_id); ?>`> class="text-57">View order/</a>
				...
				<div class="wp-edit-body  h-100 pt-20">
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-10">
							<div class="w-400px text-c01f5e">Total price of single dose：<?php echo htmlentities($order['price']); ?>元</div>
						</div>
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
							<div class="size-14 item-text w-400px d-flex align-items-start justify-content-start">
								...
								<div>退款原因退款原因退款原因退款原因退款原因退款原因退款原因</div>
							</div>
							<div class="size-14 item-text w-400px d-flex align-items-start justify-content-start ml-50">
								...
								<div>退款说明退款说明退款说明退款说明退款说明退款说明退款说明</div>
							</div>
						</div>
						<div class="w-100 mt-20 d-flex align-items-center justify-content-start">
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-10 d-flex align-items-center justify-content-start">
							<div class="size-14 item-text w-400px">Name：Name</div>
						...
						<div class="w-100 mt-10">
							<div class="d-flex align-items-start justify-content-start">
								<div class="h-100 w-150px">Logistics tracking：</div>
					...
					<div class="items w-100">
						...
						<div class="w-100 mt-10 ivu-table-wrapper ivu-table-wrapper-with-border">
							<table class="ivu-table  ivu-table-default ivu-table-border entbableth" style="overflow: initial">
								...
								<tr>
									...
									<td class="text-center text-57 t-table-td" style="width: 228px;">Microtabs name</td>
						...
						<div class="w-100 mt-10">
							<div class="w-400px">Cooperation Platform：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Organization name：XXX</div>
						</div>

						<div class="w-100 mt-10">
							<div class="w-400px">Doctor's name：XXX</div>
						</div>
