<?php /*a:5:{s:61:"F:\WWW\yeshai\app\platform_us\view\crm\institution\doctor.php";i:1606116629;s:52:"F:\WWW\yeshai\app\platform_us\view\public\header.php";i:1605782084;s:61:"F:\WWW\yeshai\app\platform_us\view\public\header_navigate.php";i:1605783593;s:52:"F:\WWW\yeshai\app\platform_us\view\public\footer.php";i:1592563283;s:58:"F:\WWW\yeshai\app\platform_us\view\public\inner_footer.php";i:1595304974;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
 ...
 $eb = parent._mpApi;
	...
	<div class="h-100 w-100 crm-doctor-p" id="app">
		...
		<div class="w-1200 mt-80 mb-10 tip text-666 size-14">
			<a class="text-57">Home /</a> <a href="index.html" class="text-57">Cooperation Organization Management/ </a> <span class="text-c01f5e">Subordinate doctors </span>
		</div>
		<!--搜索区-->
					...
					<div class="h-100 pl-20 d-flex align-items-center justify-content-start flex-column mt-20 mb-20">
						...
						<div class="h-100 w-300px mr-30 mb-10">
							...
							<div class="w-100 mt-8">
								<input class="ivu-input  w-100" type="text" placeholder="Star → End" id="test13" v-model="time">
							</div>
						</div>

					</div>

					<div class="w-25 h-100 mt-30  d-flex align-items-start justify-content-end ">
		...
		<div class="w-1200 label-list mt-20 mb-30 bg-fff">
			<div class="w-100 list-title d-flex align-items-center justify-content-between mb-20 pt-20">
				<span class="size-16  ml-20"><span class="fw">Subordinate Doctors List</span> <span class="size-14">（<?php echo htmlentities($name); ?>）</span> </span>
			</div>
			...
			<div class="w-100 table ">
				...
				<table class="ivu-table  ivu-table-default" style="overflow: initial">
					...
					<tr class="ivu-table-header cursor">
						<th class="pl-30 bg-f6 w-100px">No.</th>
						<th class="bg-f6 w-100px">Name</th>
						<th class="bg-f6 w-150px">Contact number</th>
						<th class="bg-f6 w-100px">Register time</th>
						<th class="bg-f6 w-250px">Organization</th>
						<th class="bg-f6 w-150px">Scripts</th>
						<th class="bg-f6 w-150px">Completed orders</th>
						<th class="bg-f6 w-120px">Total turnover</th>
					</tr>
