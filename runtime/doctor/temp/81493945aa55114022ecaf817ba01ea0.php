<?php /*a:4:{s:53:"F:\WWW\yeshai\app\doctor\view\crm\crm_order\index.php";i:1603786252;s:47:"F:\WWW\yeshai\app\doctor\view\public\header.php";i:1602238877;s:47:"F:\WWW\yeshai\app\doctor\view\public\footer.php";i:1603783219;s:53:"F:\WWW\yeshai\app\doctor\view\public\inner_footer.php";i:1603783219;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
	...
	var app = new Vue({
		...
		methods: {
			...
			getitems() {
				...
				axios.post("<?php echo Url('prescription_list',['type'=>$type]); ?>", data).then((e) => {
					e=e.data;
					this.data = e.data;
					this.total= e.count;
				});
