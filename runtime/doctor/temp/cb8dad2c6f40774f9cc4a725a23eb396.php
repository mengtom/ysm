<?php /*a:4:{s:44:"F:\WWW\yeshai\app\doctor\view\ts\ts\edit.php";i:1603791340;s:47:"F:\WWW\yeshai\app\doctor\view\public\header.php";i:1602238877;s:47:"F:\WWW\yeshai\app\doctor\view\public\footer.php";i:1603783219;s:53:"F:\WWW\yeshai\app\doctor\view\public\inner_footer.php";i:1603783219;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
	...
	<div id="app" class="ts-edit pr-20 pl-20 mw-1160">
		...
		<div class="w-100  mt-10 pb-10 mb-30" style="border-radius: 1px;">
			<form class="d-flex w-100 layui-form  align-items-start justify-content-between" id="formput" action="<?php echo Url('save',array('id'=>$info['id'])); ?>" method="post">
				<div class="wp-edit-body h-100 pt-20 bg-fff">
					...
					<div class="items pl-30 w-100">
						<div class="item w-100 mt-20">
							...
							<div class="w-100 mt-8">
								<input type="text" placeholder="由英文/数字/符号组成" class="ivu-input ml0 w-400px" name="code" value="<?php echo htmlentities($info['code']); ?>">
							</div>
						</div>
						...
						<div class="item w-100 d-flex align-items-center justify-content-start mt-20">
							<div>
								...
								<div class="w-100 mt-8">
									<input type="text" placeholder="由中文/英文/数字/符号组成" class="ivu-input w-400px" name="name_zn" value="<?php echo htmlentities($info['name_zn']); ?>">
								</div>
							</div>
							<div style="margin-left: 40px;">
								<div class="size-14 item-text">Name</div>
								<div class="w-100 mt-8">
									<input type="text" placeholder="由英文/数字/符号组成" class="ivu-input w-400px" name="name_en" value="<?php echo htmlentities($info['name_en']); ?>">
								</div>
							</div>
						</div>
						...
						<div class="item w-100 d-flex align-items-start justify-content-start mt-20">
							<div>
								...
								<div class="w-100 mt-8">
									<i-switch <?php if($info['is_status']): ?> :value="true"<?php else: ?> :value="false"<?php endif; ?> size="large" name="is_status">
						...
						<div class="w-100 d-flex align-items-center justify-content-start flex-column  hxcflist">
							...
							<div v-for="(i,k) in hxcflistdata" class="w-100 d-flex align-items-center justify-content-around hxcfitem" style="height: 40px;">
                                ...
                                <div class="d-flex align-items-center justify-content-center w-50px">
									<i class="icon iconfont iconcha text-0081a7 cursor rmhxcfitem" :data-key="k"></i>
								</div>
							</div>
						</div>
								...
								<div class="w-100 mt-8">
									<div class="ivu-select  ivu-select-single ivu-select-default relative w-190px">
										<select id="frequency" lay-filter="frequency" class="frequency" lay-verify="required" name="taking_quency">
											...
											<option value="2" <?php if(2 == $info['taking_quency']): ?>selected="selected"<?php endif; ?>>早晚各一次</option>
							...
							<div class="w-100 mt-8">
								<div class="ivu-select  ivu-select-single ivu-select-default relative w-400px">
									<select name="taking_cycle" id="period" class="period" lay-filter="period" lay-verify="required">
										...
										<!--<option value="10" <?php if('10' == $info['taking_cycle']): ?>selected="selected"<?php endif; ?>>10天</option>
										<option value="20" <?php if('20' == $info['taking_cycle']): ?>selected="selected"<?php endif; ?>>20天</option>
										<option value="30" <?php if('30' == $info['taking_cycle']): ?>selected="selected"<?php endif; ?>>30天</option>
										<option value="60" <?php if('60' == $info['taking_cycle']): ?>selected="selected"<?php endif; ?>>60天</option>
										<option value="90" <?php if('90' == $info['taking_cycle']): ?>selected="selected"<?php endif; ?>>90天</option>-->
									</select>
								</div>
							</div>
						</div>
					...
					<div class="item w-100 pl-30 mt-20 d-flex align-items-start justify-content-start">
						<div>
							...
							<div class="w-100 mt-8">
								<textarea rows="3" placeholder="请输入" class="ivu-input w-400px" name="description"> <?php echo htmlentities($info['description']); ?></textarea>
							</div>
						</div>
						<div style="margin-left: 50px;">
							<div class=" size-14 item-text">参考</div>
							<div class="w-100 mt-8">
								<textarea rows="3" placeholder="请输入" class="ivu-input w-400px" name="reference"> <?php echo htmlentities($info['reference']); ?></textarea>
							</div>
						</div>
					</div>
		...
		data   : {
			...
			hxcflistdata:[
				<?php if(is_array($microchip) || $microchip instanceof \think\Collection || $microchip instanceof \think\Paginator): $i = 0; $__LIST__ = $microchip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
				{
					...
					name: '<?php echo htmlentities($v['name_zn']); ?>',
