<?php /*a:4:{s:52:"F:\WWW\yeshai\app\doctor\view\ts\ts\prescription.php";i:1603791340;s:47:"F:\WWW\yeshai\app\doctor\view\public\header.php";i:1602238877;s:47:"F:\WWW\yeshai\app\doctor\view\public\footer.php";i:1603783219;s:53:"F:\WWW\yeshai\app\doctor\view\public\inner_footer.php";i:1603783219;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
	...
	<div id="app" class="ts-edithzcf pr-20 pl-20 mw-1160">
		...
		<div class="w-100 fw size-20 mt-10 text-27 d-flex align-items-center justify-content-between">
			<span>生成患者处方</span>
			<a href="<?php echo Url('purchase',array('id'=>$id)); ?>" class="ivu-btn-primary ivu-btn"><i class="icon iconfont iconyishenghoutai-qiehuan1 mr-8"></i>切换为采购订单</a>
		</div>
		<!--列表-->
		<div class="w-100  mt-10 pb-10 mb-30" style="border-radius: 1px;">
			<form class="d-flex w-100 layui-form  align-items-start justify-content-start" action="<?php echo Url('savePrescription'); ?>" method="post">
