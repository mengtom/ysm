<?php /*a:4:{s:46:"F:\WWW\yeshai\app\doctor\view\ts\ts\create.php";i:1603792445;s:47:"F:\WWW\yeshai\app\doctor\view\public\header.php";i:1602238877;s:47:"F:\WWW\yeshai\app\doctor\view\public\footer.php";i:1603783219;s:53:"F:\WWW\yeshai\app\doctor\view\public\inner_footer.php";i:1603783219;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
	...
	<div id="app" class="ts-edit pr-20 pl-20 mw-1160">
		...
		<div class="w-100  mt-10 pb-10 mb-30" style="border-radius: 1px;">
			<form class="d-flex w-100 layui-form  align-items-start justify-content-between" id="formput" action="<?php echo Url('save'); ?>" method="post">
					...
					<div class="items pl-30 w-100">
						...
						<div class="item w-100 d-flex align-items-start justify-content-start mt-20">
							<div>
								...
								<div class="w-100 mt-8">
									<i-switch :value="true" size="large" name="is_status">
	...
	var app = new Vue({
		...
		data   : {
			...
			hxcflistdata: [
				...
				{"id"     : '<?php echo htmlentities($m['id']); ?>',
				"kind"    : '<?php echo htmlentities($m['id']); ?>',
				"pid"     : '0',
				"name"    : '<?php echo htmlentities($m['zn_name']); ?>',
				"scope"   : '<?php echo htmlentities($m['dose_min']); ?>-<?php echo htmlentities($m['dose_max']); ?>',
				"maxnum"  : '<?php echo htmlentities(round($m["dose_max"]/$m["dose"])); ?>',
				'unit'    : '<?php echo htmlentities($m['unit']); ?>',
				"val"     : '1',
				'dosage'  : '<?php echo htmlentities($m['dose']); ?>',
				"dosage1" : '<?php echo htmlentities($m['dose']); ?>',
				"rmbprice": '<?php echo htmlentities($m['plat_price']); ?>',
				"is_status": '<?php echo htmlentities($m['is_show']); ?>',
				},
				<?php endforeach; endif; else: echo "" ;endif; ?>
			],
			factsdata   : [],
