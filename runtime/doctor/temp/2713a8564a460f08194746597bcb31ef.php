<?php /*a:3:{s:45:"F:\WWW\yeshai\app\doctor\view\index\index.php";i:1603187334;s:47:"F:\WWW\yeshai\app\doctor\view\public\header.php";i:1602238877;s:47:"F:\WWW\yeshai\app\doctor\view\public\footer.php";i:1603783219;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="public-top-left h-100">
        <div class="public-top-nav w-100 d-flex align-items-center justify-content-between">
            <div class="h-100 d-flex align-items-center justify-content-start">
                <img class="logo ml-20" src="/ysm/static/images/doctor/logo-3@3x.png" alt="">
            </div>
            <div class="d-flex align-items-center justify-content-start">
                ...
                <div class="ml-20">
                    <img class="picture" src="/ysm/static/images/doctor/portrait@3x.png" alt="">
                </div>
                <div class="mr-20 ml-10  cursor relative usertext">
                    <span class="text-fff"><?php echo htmlentities($_doctor['name']); ?></span>
                    ...
                    <div class="absolute bg-fff userlist">
                        <div class="d-flex align-items-center justify-content-center flex-column w-100 h-100">
                            <div class="w-100 d-flex align-items-center justify-content-center text-0081a7" style="height: 50px;"><a href="<?php echo Url('login/logout'); ?>" class="text-0081a7" >注销</a ></div>
        ...
        <div class="public-button d-flex align-items-start justify-content-start">
                ...
                <ul class="ivu-menu ivu-menu-light ivu-menu-vertical" style="width: 206px;">
                    <li class="ivu-menu-submenu ">
                        <div class="ivu-menu-submenu-title ivu-menu-item-active">
                            <a class="w-100 h-100 d-block text-57" href="<?php echo Url('main'); ?>" target="myFrameRight">
                    ...
                    <li class="ivu-menu-submenu">
                        <div class="ivu-menu-submenu-title">
                            <a class="w-100 h-100 d-block text-57" target="myFrameRight" href="<?php echo Url('microchip.microchip_product/index'); ?>">
                    ...
                    <li class="ivu-menu-submenu">
                        ...
                        <ul class="ivu-menu" style="display: none;">
                            <li class="ivu-menu-item pl-63">
                                <a target="myFrameRight" class="w-100 h-100 d-block" href="<?php echo Url('ts.ts/index'); ?>">
                                    全部配方
                                </a>
                            </li>
                            <li class="ivu-menu-item pl-63">
                                <a target="myFrameRight" class="w-100 h-100 d-block" href="<?php echo Url('ts.ts/index',array('type'=>1)); ?>">
                                    参考配方
                                </a>
                            </li>
                            <li class="ivu-menu-item pl-63">
                                <a target="myFrameRight" class="w-100 h-100 d-block" href="<?php echo Url('ts.ts/index',array('type'=>2)); ?>">
                                    我的配方
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="ivu-menu-submenu">
                        ...
                        <ul class="ivu-menu">
                            <li class="ivu-menu-item pl-63">
                                <a class="w-100 h-100 d-block" href="<?php echo Url('crm.crm_order/index',array('type'=>1)); ?>" target="myFrameRight">患者处方</a>
                            </li>
                            <li class="ivu-menu-item pl-63">
                                <a class="w-100 h-100 d-block" href="<?php echo Url('crm.crm_order/order',array('type'=>0)); ?>" target="myFrameRight">患者订单</a>
                            </li>
                            <li class="ivu-menu-item pl-63">
                                <a class="w-100 h-100 d-block" href="<?php echo Url('crm.crm_order/order',array('type'=>1)); ?>" target="myFrameRight">采购订单</a>
                            </li>
                        </ul>
                    </li>
                    <li class="ivu-menu-submenu">
            ...
            <div class="public-button-right h-100">
                <iframe class="w-100 h-100 iframe" src="<?php echo Url('main'); ?>" name="myFrameRight" width="100%" height="100%"></iframe>
            </div>
        </div>
    </div>
</body>
